...
/**
 * Stylised skull icon — front-facing view with eye sockets, nose cavity,
 * and teeth line. Used as the button image for the skull model.
 */
const SKULL_THUMBNAIL = `<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
...
/**
 * Stylised head icon — profile/side view with eye, nose, mouth, and ear.
 * Used as the button image for the head model.
 */
const HEAD_THUMBNAIL = `<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
