...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function sc(e,t,n){let r=new Float32Array(qs),i=new K(0,1,0);return new io({name:`SphericalGaussianBlur`,defines:{n:qs,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:uc(),fragmentShader:`
...
`)}var Il={1:`Linear`,2:`Reinhard`,3:`Cineon`,4:`ACESFilmic`,6:`AgX`,7:`Neutral`,5:`Custom`};function Ll(e,t){let n=Il[t];return n===void 0?(V(`WebGLProgram: Unsupported toneMapping:`,t),`vec3 `+e+`( vec3 color ) { return LinearToneMapping( color ); }`):`vec3 `+e+`( vec3 color ) { return `+n+`ToneMapping( color ); }`}var Rl=new K;function zl(){return J.getLuminanceCoefficients(Rl),[`float luminance( const in vec3 rgb ) {`,`	const vec3 weights = vec3( ${Rl.x.toFixed(4)}, ${Rl.y.toFixed(4)}, ${Rl.z.toFixed(4)} );`,`	return dot( weights, rgb );`,`}`].join(`
...
`)+`
`+_);let y=v+g+o,b=v+_+s,x=Ol(i,i.VERTEX_SHADER,y),S=Ol(i,i.FRAGMENT_SHADER,b);i.attachShader(h,x),i.attachShader(h,S),n.index0AttributeName===void 0?n.morphTargets===!0&&i.bindAttribLocation(h,0,`position`):i.bindAttribLocation(h,0,n.index0AttributeName),i.linkProgram(h);function C(t){if(e.debug.checkShaderErrors){let n=i.getProgramInfoLog(h)||``,r=i.getShaderInfoLog(x)||``,a=i.getShaderInfoLog(S)||``,o=n.trim(),s=r.trim(),c=a.trim(),l=!0,u=!0;if(i.getProgramParameter(h,i.LINK_STATUS)===!1)if(l=!1,typeof e.debug.onShaderError==`function`)e.debug.onShaderError(i,h,x,S);else{let e=Pl(i,x,`vertex`),n=Pl(i,S,`fragment`);H(`THREE.WebGLProgram: Shader Error `+i.getError()+` - VALIDATE_STATUS `+i.getProgramParameter(h,i.VALIDATE_STATUS)+`
...
205 84 112 140 167 205 200 71 37 106 41 163 21z"/>
  ...
  </svg>`,gf=`<svg version="1.0" xmlns="http://www.w3.org/2000/svg"
...
236 -736 419 -1161 561 -428 143 -853 228 -1323 264 -121 9 -669 11 -796 3z"/>
...
</svg>`,_f=[{id:`skull.obj`,label:`Skull`,thumbnail:mf},{id:`head.obj`,label:`Head`,thumbnail:gf},{id:`anime-head.obj`,label:`Anime Head`,thumbnail:gf}];function vf(e){return _f.find(t=>t.id===e)}function yf(){return _f}function bf(){return _f[0]?.id??`skull.obj`}var xf=e=>180/Math.PI*e,Sf=e=>Math.PI/180*e;function Cf(e){let t=e%360;return t<0?t+360:t}function wf(e,t){let n=e.getAzimuthalAngle(),r=e.getPolarAngle(),i=t.position.distanceTo(e.target);return{theta:Cf(xf(n)),phi:90-xf(r),radius:i}}function Tf(e,t,n){let r=Sf(n.theta),i=Sf(90-n.phi),a=n.radius,o=Math.sin(i);t.position.set(a*o*Math.sin(r),a*Math.cos(i),a*o*Math.cos(r)),e.target.set(0,0,0),e.update()}var Ef=220,Df=290,Of=Ef/2,kf=70,Af=88,jf=8,Mf=44;function Nf(e,t){let n=document.createElement(`div`);n.className=`light-control`,n.style.cssText=`
    position: relative;
    width: ${Ef}px;
    height: ${Df}px;
    margin: 0 auto;
    touch-action: none;
    user-select: none;
  `;let r=`http://www.w3.org/2000/svg`,i=document.createElementNS(r,`svg`);i.setAttribute(`viewBox`,`0 0 ${Ef} ${Df}`),i.setAttribute(`width`,String(Ef)),i.setAttribute(`height`,String(Df)),i.style.display=`block`;let a=document.createElementNS(r,`circle`);a.setAttribute(`cx`,String(Of)),a.setAttribute(`cy`,String(Df*.38)),a.setAttribute(`r`,String(kf)),a.setAttribute(`fill`,`none`),a.setAttribute(`stroke`,`var(--border)`),a.setAttribute(`stroke-width`,`2`),i.append(a);let o=document.createElementNS(r,`path`);o.setAttribute(`fill`,`none`),o.setAttribute(`stroke`,`var(--accent)`),o.setAttribute(`stroke-width`,`3`),o.setAttribute(`stroke-linecap`,`round`),i.append(o);let s=document.createElementNS(r,`path`);s.setAttribute(`fill`,`none`),s.setAttribute(`stroke`,`var(--border)`),s.setAttribute(`stroke-width`,`2`),i.append(s);let c=document.createElementNS(r,`path`);c.setAttribute(`fill`,`none`),c.setAttribute(`stroke`,`var(--accent)`),c.setAttribute(`stroke-width`,`3`),c.setAttribute(`stroke-linecap`,`round`),i.append(c);let l=document.createElementNS(r,`path`);l.setAttribute(`fill`,`none`),l.setAttribute(`stroke`,`var(--border)`),l.setAttribute(`stroke-width`,`2`),i.append(l);let u=document.createElementNS(r,`path`);u.setAttribute(`fill`,`none`),u.setAttribute(`stroke`,`var(--accent)`),u.setAttribute(`stroke-width`,`3`),u.setAttribute(`stroke-linecap`,`round`),i.append(u);let d=document.createElementNS(r,`text`);d.setAttribute(`x`,String(Of-kf-2)),d.setAttribute(`y`,`234.2`),d.setAttribute(`text-anchor`,`end`),d.setAttribute(`fill`,`var(--text-muted)`),d.setAttribute(`font-size`,`10`),d.setAttribute(`font-family`,`var(--font-sans)`),d.textContent=`◀`,i.append(d);let f=document.createElementNS(r,`text`);f.setAttribute(`x`,`182`),f.setAttribute(`y`,`234.2`),f.setAttribute(`text-anchor`,`start`),f.setAttribute(`fill`,`var(--text-muted)`),f.setAttribute(`font-size`,`10`),f.setAttribute(`font-family`,`var(--font-sans)`),f.textContent=`▶`,i.append(f);let p=document.createElementNS(r,`path`);p.setAttribute(`fill`,`none`),p.setAttribute(`stroke`,`var(--border)`),p.setAttribute(`stroke-width`,`2`),i.append(p);let m=document.createElementNS(r,`path`);m.setAttribute(`fill`,`none`),m.setAttribute(`stroke`,`var(--accent)`),m.setAttribute(`stroke-width`,`3`),m.setAttribute(`stroke-linecap`,`round`),i.append(m);let h=document.createElementNS(r,`text`);h.setAttribute(`x`,String(Of-kf-2)),h.setAttribute(`y`,`266.2`),h.setAttribute(`text-anchor`,`end`),h.setAttribute(`fill`,`var(--text-muted)`),h.setAttribute(`font-size`,`10`),h.setAttribute(`font-family`,`var(--font-sans)`),h.textContent=`◀`,i.append(h);let g=document.createElementNS(r,`text`);g.setAttribute(`x`,`182`),g.setAttribute(`y`,`266.2`),g.setAttribute(`text-anchor`,`start`),g.setAttribute(`fill`,`var(--text-muted)`),g.setAttribute(`font-size`,`10`),g.setAttribute(`font-family`,`var(--font-sans)`),g.textContent=`▶`,i.append(g);function _(e,t){let n=document.createElementNS(r,`text`);return n.setAttribute(`x`,String(Of)),n.setAttribute(`y`,String(t)),n.setAttribute(`text-anchor`,`middle`),n.setAttribute(`fill`,`var(--text-secondary)`),n.setAttribute(`font-size`,`9`),n.setAttribute(`font-family`,`var(--font-sans)`),n.setAttribute(`opacity`,`0.7`),n.textContent=e,i.append(n),n}_(`SOFTNESS`,218.2),_(`INTENSITY`,250.2);let v=document.createElementNS(r,`circle`);v.setAttribute(`r`,`8`),v.setAttribute(`fill`,`var(--accent)`),v.setAttribute(`stroke`,`#fff`),v.setAttribute(`stroke-width`,`2`),v.setAttribute(`cursor`,`grab`),i.append(v);let y=document.createElementNS(r,`circle`);y.setAttribute(`r`,`14`),y.setAttribute(`fill`,`none`),y.setAttribute(`stroke`,`var(--accent)`),y.setAttribute(`stroke-width`,`1`),y.setAttribute(`opacity`,`0.3`),i.append(y);let b=document.createElementNS(r,`circle`);b.setAttribute(`r`,String(jf)),b.setAttribute(`fill`,`var(--accent)`),b.setAttribute(`stroke`,`#fff`),b.setAttribute(`stroke-width`,`2`),b.setAttribute(`cursor`,`grab`),i.append(b);let x=document.createElementNS(r,`circle`);x.setAttribute(`r`,String(jf)),x.setAttribute(`fill`,`var(--accent-hover)`),x.setAttribute(`stroke`,`#fff`),x.setAttribute(`stroke-width`,`2`),x.setAttribute(`cursor`,`grab`),i.append(x);let S=document.createElementNS(r,`circle`);S.setAttribute(`r`,String(jf)),S.setAttribute(`fill`,`var(--accent-hover)`),S.setAttribute(`stroke`,`#fff`),S.setAttribute(`stroke-width`,`2`),S.setAttribute(`cursor`,`grab`),i.append(S);let C=document.createElementNS(r,`circle`);C.setAttribute(`r`,String(jf)),C.setAttribute(`fill`,`var(--accent-hover)`),C.setAttribute(`stroke`,`#fff`),C.setAttribute(`stroke-width`,`2`),C.setAttribute(`cursor`,`grab`),i.append(C);let w=document.createElement(`div`);w.style.cssText=`
    display: grid;
  ...
  `;function T(e){w.innerHTML=`
    ...
    `}n.append(i,w);let E=Df*.38;function D(e,t){let n=(e-90)*(Math.PI/180);return{x:Of+t*Math.cos(n),y:E+t*Math.sin(n)}}function O(e,t){let n=e-Of,r=t-E,i=180/Math.PI*Math.atan2(r,n)+90;return i<0&&(i+=360),i%360}function k(e){let t=(e+180)*(Math.PI/180);return{x:Of+Af*Math.cos(t),y:E+Af*Math.sin(t)}}function A(e,t){let n=e-Of,r=t-E,i=180/Math.PI*Math.atan2(r,n);return i<0&&(i+=360),i>=180&&i<=270?i-180:i<180?0:90}function ee(e,t){let n=e-Of,r=t-E,i=Math.sqrt(n*n+r*r),a=kf*.65;return(1-Math.min(a,Math.max(0,i))/a)*90}function te(e){return{x:Of-kf+e*2*kf,y:230.2}}function j(e){return(Math.min(180,Math.max(Of-kf,e))-(Of-kf))/(2*kf)}function ne(e){let t=Math.min(1,Math.max(0,e/5));return{x:Of-kf+t*2*kf,y:262.2}}function M(e){return(Math.min(180,Math.max(Of-kf,e))-(Of-kf))/(2*kf)*5}function N(e,t,n,r,i){if(Math.abs(i-r)<.01)return``;let a=(r-90)*(Math.PI/180),o=(i-90)*(Math.PI/180),s=e+n*Math.cos(a),c=t+n*Math.sin(a),l=e+n*Math.cos(o),u=t+n*Math.sin(o);return`M ${s} ${c} A ${n} ${n} 0 ${+(Math.abs(i-r)>180)} 1 ${l} ${u}`}function re(e,t,n){return`M ${e} ${t} L ${n} ${t}`}function ie(e){o.setAttribute(`d`,e.azimuth>0?N(Of,E,kf,0,e.azimuth):``);let t=D(e.azimuth,kf);b.setAttribute(`cx`,String(t.x)),b.setAttribute(`cy`,String(t.y));let n=N(Of,E,Af,270,360);s.setAttribute(`d`,n),e.elevation>0?c.setAttribute(`d`,N(Of,E,Af,270,270+e.elevation)):c.setAttribute(`d`,``);let r=k(e.elevation);x.setAttribute(`cx`,String(r.x)),x.setAttribute(`cy`,String(r.y));let i=Of-kf,a=230.2;l.setAttribute(`d`,re(i,a,180));let d=te(e.softness);u.setAttribute(`d`,re(i,a,d.x)),S.setAttribute(`cx`,String(d.x)),S.setAttribute(`cy`,String(d.y));let f=262.2;p.setAttribute(`d`,re(i,f,180));let h=ne(e.intensity);m.setAttribute(`d`,re(i,f,h.x)),C.setAttribute(`cx`,String(h.x)),C.setAttribute(`cy`,String(h.y));let g=(e.azimuth-90)*(Math.PI/180),_=(1-e.elevation/90)*kf*.65,w=Of+_*Math.cos(g),O=E+_*Math.sin(g);v.setAttribute(`cx`,String(w)),v.setAttribute(`cy`,String(O)),y.setAttribute(`cx`,String(w)),y.setAttribute(`cy`,String(O)),T(e)}ie(e);let ae=null;function oe(e,t){let n=i.getBoundingClientRect(),r=e-n.left,a=t-n.top,o=Ef/n.width,s=Df/n.height,c=r*o,l=a*s,u=c-Of,d=l-E,f=Math.sqrt(u*u+d*d);return Math.abs(l-230.2)<Mf*s*.4&&Math.abs(c-Of)<kf+Mf*o*.4?`softness`:Math.abs(l-262.2)<Mf*s*.4&&Math.abs(c-Of)<kf+Mf*o*.4?`intensity`:c<Of&&Math.abs(f-Af)<Mf*o*.5?`elevation`:Math.abs(f-kf)<Mf*o*.5?`azimuth`:f<kf+Mf*o*.3?`direction`:null}function P(e){e.preventDefault(),i.setPointerCapture(e.pointerId);let t=oe(e.clientX,e.clientY);if(t){ae=t;let n=e.currentTarget;n.style.cursor=`grabbing`,F(e,t)}}function se(e){ae&&(e.preventDefault(),F(e,ae))}function ce(e){if(!ae)return;ae=null;let t=e.currentTarget;t.style.cursor=`default`,i.releasePointerCapture(e.pointerId)}function F(n,r){let a=i.getBoundingClientRect(),o=Ef/a.width,s=Df/a.height,c=(n.clientX-a.left)*o,l=(n.clientY-a.top)*s,u={...e};switch(r){case`azimuth`:u.azimuth=O(c,l);break;case`elevation`:u.elevation=A(c,l);break;case`softness`:u.softness=Math.min(1,Math.max(0,j(c)));break;case`intensity`:u.intensity=Math.min(5,Math.max(0,M(c)));break;case`direction`:u.azimuth=O(c,l),u.elevation=ee(c,l);break}e=u,ie(u),t(u)}return i.addEventListener(`pointerdown`,P),i.addEventListener(`pointermove`,se),i.addEventListener(`pointerup`,ce),i.addEventListener(`pointercancel`,ce),n._updateLight=t=>{e=t,ie(t)},n._dispose=()=>{i.removeEventListener(`pointerdown`,P),i.removeEventListener(`pointermove`,se),i.removeEventListener(`pointerup`,ce),i.removeEventListener(`pointercancel`,ce)},n}var Pf=[[`tl`,uf],[`tr`,df],[`bl`,ff],[`br`,pf]],Ff={id:`btn`,label:`Button Position`,type:`select`,defaultValue:`tr`,serialize:e=>e,deserialize:e=>e===`tl`||e===`tr`||e===`bl`||e===`br`?e:`tr`,createControl(e,t){let n=document.createElement(`div`);n.className=`button-position-grid`;let r=[];function i(e){for(let t of r)t.classList.toggle(`is-selected`,t.dataset.corner===e)}for(let[a,o]of Pf){let s=document.createElement(`button`);s.type=`button`,s.className=`button-position-btn`,s.dataset.corner=a,s.setAttribute(`aria-label`,`Position buttons at ${a.replace(`tl`,`top-left`).replace(`tr`,`top-right`).replace(`bl`,`bottom-left`).replace(`br`,`bottom-right`)}`),s.innerHTML=o,a===e&&s.classList.add(`is-selected`),s.addEventListener(`click`,()=>{s.dataset.corner&&(i(s.dataset.corner),t(s.dataset.corner))}),n.append(s),r.push(s)}return n._selectButton=i,n}};function If(e,t,n){return Math.min(n,Math.max(t,e))}var Lf={id:`keylight`,label:`Key Light`,type:`light`,defaultValue:{azimuth:45,elevation:30,intensity:2.5,softness:.5},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...Lf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...Lf.defaultValue}:{azimuth:If(t[0],0,360),elevation:If(t[1],0,90),intensity:If(t[2],0,5),softness:If(t[3],0,1)}},createControl(e,t){return Nf(e,t)}},Rf={id:`fill`,label:`Fill Light`,type:`light`,defaultValue:{azimuth:225,elevation:20,intensity:.4,softness:0},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...Rf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...Rf.defaultValue}:{azimuth:If(t[0],0,360),elevation:If(t[1],0,90),intensity:If(t[2],0,5),softness:If(t[3],0,1)}},createControl(e,t){return Nf(e,t)}},zf={id:`rim`,label:`Back Light`,type:`light`,defaultValue:{azimuth:180,elevation:30,intensity:.3,softness:0},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...zf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...zf.defaultValue}:{azimuth:If(t[0],0,360),elevation:If(t[1],0,90),intensity:If(t[2],0,5),softness:If(t[3],0,1)}},createControl(e,t){return Nf(e,t)}},Bf=[{id:`model`,label:`Model`,type:`select`,defaultValue:bf(),serialize:e=>e,deserialize:e=>{if(e===null)return bf();let t=vf(e);return t?t.id:bf()},createControl(e,t){let n=document.createElement(`div`);n.className=`model-select-grid`;let r=yf(),i=[];function a(e){for(let t of i)t.classList.toggle(`is-selected`,t.dataset.model===e)}for(let o of r){let r=document.createElement(`button`);r.type=`button`,r.className=`model-select-btn`,r.dataset.model=o.id,r.setAttribute(`aria-label`,o.label),r.innerHTML=o.thumbnail,o.id===e&&r.classList.add(`is-selected`),r.addEventListener(`click`,()=>{r.dataset.model&&(a(r.dataset.model),t(r.dataset.model))}),n.append(r),i.push(r)}return n._selectModel=a,n}},Ff,{id:`bg`,label:`Background`,type:`color`,defaultValue:`#111111`,serialize:e=>e,deserialize:e=>typeof e==`string`&&/^#[0-9a-fA-F]{6}$/.test(e)?e:`#111111`,createControl(e,t){let n=document.createElement(`input`);return n.type=`color`,n.value=e,n.style.cssText=`
      width: 44px;
      height: 44px;
      padding: 4px;
    ...
    `;let i=document.createElement(`span`);return i.style.cssText=`
      ...
      min-width: 28px;
      text-align: right;
    `,i.textContent=e.toFixed(2),r.oninput=()=>{let e=parseFloat(r.value);i.textContent=e.toFixed(2),t(e)},n.append(r,i),n}},Nd,Lf,Rf,zf],Vf={};for(let e of Bf)Vf[e.id]=e.defaultValue;var Hf=new Set;function Uf(e){return Vf[e]}function Wf(e,t){Vf[e]=t;for(let n of Hf)n(e,t)}function Gf(e){return Hf.add(e),()=>{Hf.delete(e)}}var Kf=1;function qf(e,t,n){let r=new URLSearchParams;r.set(`v`,String(Kf)),e&&e.length>0&&r.set(`model`,e);let i=wf(t,n);r.set(`cam`,`${i.theta},${i.phi},${i.radius}`);for(let e of Bf){if(e.id===`model`)continue;let t=Uf(e.id);t!==e.defaultValue&&r.set(e.id,e.serialize(t))}return r.toString()}function Jf(e){let t=new URLSearchParams(e??window.location.search),n=t.get(`v`);if(n===null)return{version:Kf,model:null,camera:null,settings:{}};let r=parseInt(n,10);if(isNaN(r)||r!==1)return null;let i=t.get(`model`)||null,a=null,o=t.get(`cam`);if(o){let e=o.split(`,`).map(e=>e.trim()).map(Number);e.length===3&&e.every(e=>!isNaN(e))&&(a={theta:e[0],phi:e[1],radius:e[2]})}let s={};for(let e of Bf)s[e.id]=e.deserialize(t.get(e.id));return i!==null&&(s.model=i),{version:r,model:i,camera:a,settings:s}}function Yf(e,t){let n=null;function r(...r){n!==null&&clearTimeout(n),n=setTimeout(()=>{n=null,e(...r)},t)}function i(){n!==null&&(clearTimeout(n),n=null)}return{call:r,cancel:i}}function Xf(e,t,n){let r=qf(e,t,n),i=r.length>0?`?${r}`:window.location.pathname;history.pushState(null,``,i)}function Zf(e,t,n){let r=Yf(()=>{Xf(e(),t,n)},300),i=Gf(()=>{r.call()}),a=()=>{r.call()};return t.addEventListener(`change`,a),function(){i(),t.removeEventListener(`change`,a),r.cancel()}}function Qf(){let e=document.createDocumentFragment();for(let t of Bf){let n=Uf(t.id),r=document.createElement(`div`);r.className=`settings-row`;let i=document.createElement(`label`);i.className=`settings-label`,i.textContent=t.label;let a=t.createControl(n,e=>{Wf(t.id,e)});a.dataset.settingId=t.id,a.className=`${a.className||``} settings-control`.trim(),r.append(i,a),e.append(r)}return e}function $f(e){let t=document.createElement(`button`);return t.id=`settings-toggle`,t.className=`settings-toggle`,t.setAttribute(`aria-label`,`Toggle settings panel`),t.innerHTML=sf,t.addEventListener(`click`,e),t}function ep(e){let t=document.createElement(`button`);return t.id=`eye-toggle`,t.className=`eye-toggle`,t.setAttribute(`aria-label`,`Toggle model visibility`),t.innerHTML=cf,t.dataset.visible=`true`,t.addEventListener(`click`,e),t}var tp={keylight:{azimuth:45,elevation:30,intensity:1,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}},np=[{label:`Front`,theta:0,phi:0,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}}},{label:`Side`,theta:90,phi:0,lights:{keylight:{azimuth:315,elevation:30,intensity:1.2,softness:.5},fill:{azimuth:135,elevation:15,intensity:.4,softness:0},rim:{azimuth:90,elevation:35,intensity:.4,softness:0}}},{label:`Three Quarter`,theta:45,phi:30,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:35,intensity:.4,softness:0}}},{label:`Top`,theta:0,phi:90,lights:{keylight:{azimuth:45,elevation:60,intensity:1,softness:.5},fill:{azimuth:225,elevation:45,intensity:.3,softness:0},rim:{azimuth:180,elevation:10,intensity:.3,softness:0}}}];function rp(e){Wf(`keylight`,{...e.keylight}),Wf(`fill`,{...e.fill}),Wf(`rim`,{...e.rim})}function ip(){Wf(`keylight`,{...tp.keylight}),Wf(`fill`,{...tp.fill}),Wf(`rim`,{...tp.rim})}function ap(e,t,n){let r=document.createElement(`div`);r.className=`view-presets`;let i=document.createElement(`span`);i.className=`settings-label`,i.textContent=`View Presets`,r.append(i);let a=document.createElement(`div`);a.className=`view-presets-grid`;for(let n of np){let r=document.createElement(`button`);r.className=`view-preset-btn`,r.textContent=n.label,r.addEventListener(`click`,()=>{let r=wf(e,t);Tf(e,t,{theta:n.theta,phi:n.phi,radius:r.radius}),n.lights&&rp(n.lights)}),a.append(r)}let o=document.createElement(`button`);return o.className=`view-preset-btn view-preset-btn--reset`,o.textContent=`Reset`,o.addEventListener(`click`,()=>{n(1),ip()}),a.append(o),r.append(a),r}var op={"skull.obj":{author:`deater07`,source:`https://free3d.com/3d-model/skull-human-anatomy-82445.html`,license:`CC0`},"head.obj":{author:`Ron lemen`,source:`Planes of the Head.blend`,license:`CC0`},"anime-head.obj":{author:`Rodesqa`,source:`https://downloadfree3d.com/characters/stylized-anime-female-head/`,license:`CC0`}};function sp(e){return op[e]??null}var cp=class{button;panel;isOpen=!1;unsub=null;currentSide=`left`;onToggle;viewerControls;modelName;constructor(e,t,n){this.modelName=n??null,this.onToggle=e??null,this.button=$f(()=>this.toggle()),this.panel=document.createElement(`aside`),this.panel.id=`settings-panel`,this.panel.className=`settings-panel`,this.viewerControls=t??null,this.populatePanel(),document.body.append(this.panel,this.button),this.onKeyDown=this.onKeyDown.bind(this),document.addEventListener(`keydown`,this.onKeyDown);let r=Uf(`btn`)??`tl`;this.applyPosition(r),this.unsub=Gf((e,t)=>{e===`btn`&&(this.applyPosition(t),this.isOpen&&this.onToggle?.(!0));let n=this.panel.querySelector(`[data-setting-id="${e}"]`);if(n){let e=n._updateLight;if(e){e(t);return}let r=n._selectPreset;if(r){r(t);return}let i=n._selectButton;if(i){i(t);return}let a=n._selectModel;if(a){a(t);return}`value`in n&&(n.value=String(t))}})}get panelElement(){return this.panel}get side(){return this.currentSide}get panelOpen(){return this.isOpen}applyPosition(e){this.button.dataset.corner=e,this.panel.dataset.corner=e,this.currentSide=e===`tl`||e===`bl`?`left`:`right`,this.panel.dataset.side=this.currentSide}toggle(){this.isOpen?this.close():this.open()}open(){this.isOpen||(this.isOpen=!0,this.button.classList.add(`is-active`),this.panel.classList.add(`is-open`),this.onToggle?.(!0))}close(){this.isOpen&&(this.isOpen=!1,this.button.classList.remove(`is-active`),this.panel.classList.remove(`is-open`),this.onToggle?.(!1))}onKeyDown(e){e.key===`Escape`&&this.isOpen&&this.close()}setModelName(e){this.modelName=e,this.updateCredits()}creditsSection=null;renderCredits(){let e=document.createElement(`div`);if(e.className=`model-credits`,!this.modelName)return e.style.display=`none`,e;let t=sp(this.modelName);if(!t)return e.style.display=`none`,e;let n=document.createElement(`div`);if(n.className=`credit-row`,n.innerHTML=`<span class="credit-label">Model</span><span class="credit-value credit-value--filename">${lp(this.modelName)}</span>`,e.append(n),t.author){let n=document.createElement(`div`);n.className=`credit-row`,n.innerHTML=`<span class="credit-label">Author</span><span class="credit-value">${lp(t.author)}</span>`,e.append(n)}if(t.source){let n=document.createElement(`div`);n.className=`credit-row`,/^https?:\/\//.test(t.source)?n.innerHTML=`<span class="credit-label">Source</span><a class="credit-value credit-value--link" href="${lp(t.source)}" target="_blank" rel="noopener noreferrer">${lp(t.source)}</a>`:n.innerHTML=`<span class="credit-label">Source</span><span class="credit-value">${lp(t.source)}</span>`,e.append(n)}if(t.license){let n=document.createElement(`div`);n.className=`credit-row`,n.innerHTML=`<span class="credit-label">License</span><span class="credit-value">${lp(t.license)}</span>`,e.append(n)}return e}renderGitHubLink(){let e=document.createElement(`a`);return e.className=`github-link`,e.href=`https://github.com/skkdevcraft/drawrefapp`,e.target=`_blank`,e.rel=`noopener noreferrer`,e.setAttribute(`aria-label`,`View source code on GitHub`),e.innerHTML=`${hf}<span>GitHub</span>`,e}updateCredits(){if(!this.creditsSection)return;let e=this.renderCredits();this.creditsSection.replaceWith(e),this.creditsSection=e}populatePanel(){if(this.panel.append(Qf()),this.viewerControls){let e=ap(this.viewerControls.controls,this.viewerControls.camera,this.viewerControls.fitCamera);this.panel.append(e)}this.creditsSection=this.renderCredits(),this.panel.append(this.creditsSection),this.panel.append(this.renderGitHubLink())}dispose(){document.removeEventListener(`keydown`,this.onKeyDown),this.unsub&&this.unsub(),this.button.remove(),this.panel.remove()}};function lp(e){let t=document.createElement(`span`);return t.textContent=e,t.innerHTML}var up=120,dp=new Map,fp=null;async function pp(e,t,n){let r=e??`__fallback__`;if(fp===r){let e=new Map;for(let t of Ed){let n=dp.get(`${r}:${t}`);n&&e.set(t,n)}if(e.size===Ed.length)return e}await new Promise(e=>setTimeout(e,0));let i;i=e?await af(e):Wd(),of(i,1);let a=Uf(`keylight`),o=Uf(`fill`),s=Uf(`rim`),c=Uf(`gloss`),l=Uf(`ambient`),u=getComputedStyle(document.documentElement).getPropertyValue(`--bg-primary`).trim()||`#111111`,d=new Map,f=t.getRenderTarget(),p=t.autoClear,m=new Kt;t.getViewport(m);let h=new Kt;t.getScissor(h);let g=t.getScissorTest(),_=new Jt(up,up);for(let e of Ed){i.traverse(e=>{e instanceof $r&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())});let{scene:f,camera:p}=Rd({model:i,background:u,ambient:l,keylight:a,fill:o,rim:s,glossiness:c,material:e,cameraState:n&&{...n,radius:n.radius*.8},aspect:1,enableShadows:!1});t.autoClear=!0,t.setRenderTarget(_),t.setScissor(0,0,up,up),t.setScissorTest(!1),t.render(f,p);let m=new Uint8Array(up*up*4);t.readRenderTargetPixels(_,0,0,up,up,m),hp(m,up);let h=gp(m,up);d.set(e,h),dp.set(`${r}:${e}`,h),f.remove(i)}return i.traverse(e=>{e instanceof $r&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),_.dispose(),t.setRenderTarget(f),t.setViewport(m),t.setScissor(h),t.setScissorTest(g),t.autoClear=p,fp=r,d}function mp(){dp.clear(),fp=null}function hp(e,t){let n=t*4,r=new Uint8Array(n);for(let i=0;i<t/2;i++){let a=i*n,o=(t-1-i)*n;r.set(e.slice(a,a+n)),e.copyWithin(a,o,o+n),e.set(r,o)}}function gp(e,t){let n=document.createElement(`canvas`);n.width=t,n.height=t;let r=n.getContext(`2d`),i=r.createImageData(t,t);return i.data.set(e),r.putImageData(i,0,0),n.toDataURL(`image/png`)}function _p(){dp.clear(),fp=null}function vp(e){let t=yd(e),n=bd(),r=Fd(),i=Vd(r,e),{ambientLight:a,keyLight:o,fillLight:s,rimLight:c}=xd(n,{enableShadows:!0,keylight:Uf(`keylight`),fill:Uf(`fill`),rim:Uf(`rim`)}),l=null;l=Wd(),n.add(l);function u(e){l&&n.remove(l),l=e,n.add(e),Ld(r,i,1),f()}function d(e=1){Ld(r,i,e)}let{requestRender:f,dispose:p}=Hd(t,n,r,i);i.addEventListener(`change`,()=>{f()}),f();function m(){let e=window.innerWidth,n=window.innerHeight;r.aspect=e/n,r.updateProjectionMatrix(),t.setSize(e,n),f()}window.addEventListener(`resize`,m);function h(){p(),i.dispose(),t.dispose(),window.removeEventListener(`resize`,m)}return{renderer:t,scene:n,camera:r,controls:i,ambientLight:a,keyLight:o,fillLight:s,rimLight:c,resize:m,fitCamera:d,requestRender:f,dispose:h,setModel:u,getModel:()=>l}}var yp=Jf();if(yp)for(let e of Bf){let t=yp.settings[e.id];t!==void 0&&Wf(e.id,t)}var bp=Uf(`model`)||(yp&&yp.model&&yp.model.trim().length>0?yp.model:bf()),xp=document.getElementById(`scene-canvas`);if(!xp)throw Error(`Expected a <canvas id="scene-canvas"> element in the DOM`);var $=vp(xp);{let e=Uf(`bg`);e&&($.scene.background=new X(e)),$.requestRender()}var Sp=null,Cp=null;af(bp).then(e=>{of(e,1),Sp=bp,Cp=e;let t=Uf(`material`);t&&kd(e,t),zd(e,Uf(`gloss`)),$.setModel(e),yp?.camera&&(Tf($.controls,$.camera,yp.camera),$.requestRender())}).catch(e=>{console.error(`[main] Failed to load model:`,e),Cp=$.getModel()}).finally(()=>{wp()});function wp(){let e=!0,t=ep(()=>{let n=$.getModel();n&&(e=!e,n.visible=e,t.innerHTML=e?cf:lf,t.dataset.visible=String(e),$.requestRender())}),n=new cp(e=>{t.classList.toggle(`is-hidden`,e),a(e,n),e?(mp(),C()):mp()},{controls:$.controls,camera:$.camera,fitCamera:$.fitCamera},Sp??bp),r=Uf(`btn`)??`tl`;t.dataset.corner=r,document.body.appendChild(t);let i=Gf((e,n)=>{e===`btn`&&(t.dataset.corner=n)});function a(e,t){let n=window.innerWidth,r=window.innerHeight,i=n,a=0;if(e){let e=t.panelElement.offsetWidth;i=n-e,t.side===`left`&&(a=e)}$.camera.aspect=i/r,$.camera.updateProjectionMatrix(),$.renderer.setSize(i,r),xp.style.left=a+`px`,$.requestRender()}window.removeEventListener(`resize`,$.resize);function o(){a(n.panelOpen,n)}window.addEventListener(`resize`,o),$.resize=o;let s=Zf(()=>Sp,$.controls,$.camera);function c(){let e=Uf(`keylight`);e&&(Sd($.keyLight,e),$.requestRender())}c();let l=Gf(e=>{e===`keylight`&&c()});function u(){let e=Uf(`fill`);e&&(Cd($.fillLight,e),$.requestRender())}u();let d=Gf(e=>{e===`fill`&&u()});function f(){let e=Uf(`rim`);e&&(wd($.rimLight,e),$.requestRender())}f();let p=Gf(e=>{e===`rim`&&f()});function m(){let e=Uf(`bg`);e&&(document.documentElement.style.backgroundColor=e,document.body.style.backgroundColor=e,$.scene.background=new X(e),$.requestRender())}m();let h=Gf(e=>{e===`bg`&&m()});function g(){let e=Uf(`ambient`);e!==void 0&&(Td($.ambientLight,e),$.requestRender())}g();let _=Gf(e=>{e===`ambient`&&g()});function v(){Cp&&(zd(Cp,Uf(`gloss`)),$.requestRender())}v();let y=Gf(e=>{e===`gloss`&&v()});function b(){if(Cp){let e=Uf(`material`);e&&(kd(Cp,e),$.requestRender())}}b();let x=Gf(e=>{e===`material`&&b()}),S=Gf(async e=>{if(e!==`model`)return;let t=Uf(`model`);if(!(!t||t===Sp))try{let e=await af(t);of(e,1);let r=Uf(`material`);r&&kd(e,r),zd(e,Uf(`gloss`)),Sp=t,Cp=e,$.setModel(e),$.requestRender(),n.setModelName(Sp),mp(),C()}catch(e){console.error(`[main] Failed to load model "`+t+`":`,e)}});function C(){let e=wf($.controls,$.camera);pp(Sp,$.renderer,e).then(e=>{let t=document.querySelector(`[data-setting-id="material"]`);if(!t)return;let n=t._setThumbnail;if(n)for(let[t,r]of e)n(t,r)})}C();let w=$.dispose.bind($);$.dispose=()=>{s(),l(),d(),p(),h(),_(),y(),x(),i(),S(),_p(),window.removeEventListener(`resize`,o),n.dispose(),t.remove(),w()}}export{ns as $,l as A,$r as B,Ne as C,Pi as D,Hi as E,ds as F,oo as G,lo as H,Mr as I,c as J,a as K,Ot as L,u as M,Be as N,qi as O,Io as P,ss as Q,q as R,_o as S,z as T,co as U,Vr as V,so as W,To as X,s as Y,wn as Z,ps as _,pr as _t,fr as a,Do as at,Or as b,Kt as bt,X as c,Nn as ct,Ho as d,di as dt,os as et,ls as f,yr as ft,Tn as g,qn as gt,hr as h,Uo as ht,Jn as i,kt as it,d as j,Ki as k,J as l,Ka as lt,zo as m,Gt as mt,Ao as n,Ji as nt,Dr as o,r as ot,sn as p,is as pt,o as q,fi as r,ks as rt,i as s,ze as st,us as t,$i as tt,da as u,gi as ut,_i as v,G as vt,Me as w,Ar as x,ko as xt,Ti as y,K as yt,Y as z};