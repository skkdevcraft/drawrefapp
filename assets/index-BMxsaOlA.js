const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FBXLoader-C7H9kinz.js","assets/fflate.module-BIQmJeC9.js","assets/3MFLoader-BOtWV8h2.js"])))=>i.map(i=>d[i]);
...
void main() {
  ...
  </svg>`;function zf(e){let t=document.createElement(`button`);return t.id=`settings-toggle`,t.className=`settings-toggle`,t.setAttribute(`aria-label`,`Toggle settings panel`),t.innerHTML=Rf,t.addEventListener(`click`,e),t}var Bf={keylight:{azimuth:45,elevation:30,intensity:1,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}},Vf=[{label:`Front`,theta:0,phi:0,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}}},{label:`Side`,theta:90,phi:0,lights:{keylight:{azimuth:315,elevation:30,intensity:1.2,softness:.5},fill:{azimuth:135,elevation:15,intensity:.4,softness:0},rim:{azimuth:90,elevation:35,intensity:.4,softness:0}}},{label:`Three Quarter`,theta:45,phi:30,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:35,intensity:.4,softness:0}}},{label:`Top`,theta:0,phi:90,lights:{keylight:{azimuth:45,elevation:60,intensity:1,softness:.5},fill:{azimuth:225,elevation:45,intensity:.3,softness:0},rim:{azimuth:180,elevation:10,intensity:.3,softness:0}}}];function Hf(e){kf(`keylight`,{...e.keylight}),kf(`fill`,{...e.fill}),kf(`rim`,{...e.rim})}function Uf(){kf(`keylight`,{...Bf.keylight}),kf(`fill`,{...Bf.fill}),kf(`rim`,{...Bf.rim})}function Wf(e,t,n){let r=document.createElement(`div`);r.className=`view-presets`;let i=document.createElement(`span`);i.className=`settings-label`,i.textContent=`View Presets`,r.append(i);let a=document.createElement(`div`);a.className=`view-presets-grid`;for(let n of Vf){let r=document.createElement(`button`);r.className=`view-preset-btn`,r.textContent=n.label,r.addEventListener(`click`,()=>{let r=uf(e,t);df(e,t,{theta:n.theta,phi:n.phi,radius:r.radius}),n.lights&&Hf(n.lights)}),a.append(r)}let o=document.createElement(`button`);return o.className=`view-preset-btn view-preset-btn--reset`,o.textContent=`Reset`,o.addEventListener(`click`,()=>{n(1),Uf()}),a.append(o),r.append(a),r}var Gf={"skull.obj":{author:`deater07`,source:`https://free3d.com/3d-model/skull-human-anatomy-82445.html`},"head.obj":{author:`Ron lemen`,source:`Planes of the Head.blend`}};function Kf(e){return Gf[e]??null}var qf=class{button;panel;isOpen=!1;unsub=null;currentSide=`left`;onToggle;viewerControls;modelName;constructor(e,t,n){this.modelName=n??null,this.onToggle=e??null,this.button=zf(()=>this.toggle()),this.panel=document.createElement(`aside`),this.panel.id=`settings-panel`,this.panel.className=`settings-panel`,this.viewerControls=t??null,this.populatePanel(),document.body.append(this.panel,this.button),this.onKeyDown=this.onKeyDown.bind(this),document.addEventListener(`keydown`,this.onKeyDown);let r=Of(`btn`)??`tl`;this.applyPosition(r),this.unsub=Af((e,t)=>{e===`btn`&&(this.applyPosition(t),this.isOpen&&this.onToggle?.(!0));let n=this.panel.querySelector(`[data-setting-id="${e}"]`);if(n){let e=n._updateLight;if(e){e(t);return}let r=n._selectPreset;if(r){r(t);return}`value`in n&&(n.value=String(t))}})}get panelElement(){return this.panel}get side(){return this.currentSide}get panelOpen(){return this.isOpen}applyPosition(e){this.button.dataset.corner=e,this.panel.dataset.corner=e,this.currentSide=e===`tl`||e===`bl`?`left`:`right`,this.panel.dataset.side=this.currentSide}toggle(){this.isOpen?this.close():this.open()}open(){this.isOpen||(this.isOpen=!0,this.button.classList.add(`is-active`),this.panel.classList.add(`is-open`),this.onToggle?.(!0))}close(){this.isOpen&&(this.isOpen=!1,this.button.classList.remove(`is-active`),this.panel.classList.remove(`is-open`),this.onToggle?.(!1))}onKeyDown(e){e.key===`Escape`&&this.isOpen&&this.close()}setModelName(e){this.modelName=e,this.updateCredits()}creditsSection=null;renderCredits(){let e=document.createElement(`div`);if(e.className=`model-credits`,!this.modelName)return e.style.display=`none`,e;let t=Kf(this.modelName);if(!t)return e.style.display=`none`,e;let n=document.createElement(`div`);if(n.className=`credit-row`,n.innerHTML=`<span class="credit-label">Model</span><span class="credit-value credit-value--filename">${Jf(this.modelName)}</span>`,e.append(n),t.author){let n=document.createElement(`div`);n.className=`credit-row`,n.innerHTML=`<span class="credit-label">Author</span><span class="credit-value">${Jf(t.author)}</span>`,e.append(n)}if(t.source){let n=document.createElement(`div`);n.className=`credit-row`,/^https?:\/\//.test(t.source)?n.innerHTML=`<span class="credit-label">Source</span><a class="credit-value credit-value--link" href="${Jf(t.source)}" target="_blank" rel="noopener noreferrer">${Jf(t.source)}</a>`:n.innerHTML=`<span class="credit-label">Source</span><span class="credit-value">${Jf(t.source)}</span>`,e.append(n)}if(t.license){let n=document.createElement(`div`);n.className=`credit-row`,n.innerHTML=`<span class="credit-label">License</span><span class="credit-value">${Jf(t.license)}</span>`,e.append(n)}return e}updateCredits(){if(!this.creditsSection)return;let e=this.renderCredits();this.creditsSection.replaceWith(e),this.creditsSection=e}populatePanel(){if(this.panel.append(Lf()),this.viewerControls){let e=Wf(this.viewerControls.controls,this.viewerControls.camera,this.viewerControls.fitCamera);this.panel.append(e)}this.creditsSection=this.renderCredits(),this.panel.append(this.creditsSection)}dispose(){document.removeEventListener(`keydown`,this.onKeyDown),this.unsub&&this.unsub(),this.button.remove(),this.panel.remove()}};function Jf(e){let t=document.createElement(`span`);return t.textContent=e,t.innerHTML}var Yf=120,Xf=new Map,Zf=null;async function Qf(e,t,n){let r=e??`__fallback__`;if(Zf===r){let e=new Map;for(let t of Ed){let n=Xf.get(`${r}:${t}`);n&&e.set(t,n)}if(e.size===Ed.length)return e}await new Promise(e=>setTimeout(e,0));let i;i=e?await af(e):Wd(),of(i,1);let a=Of(`keylight`),o=Of(`fill`),s=Of(`rim`),c=Of(`gloss`),l=getComputedStyle(document.documentElement).getPropertyValue(`--bg-primary`).trim()||`#111111`,u=new Map,d=t.getRenderTarget(),f=t.autoClear,p=new Kt;t.getViewport(p);let m=new Kt;t.getScissor(m);let h=t.getScissorTest(),g=new Jt(Yf,Yf);for(let e of Ed){i.traverse(e=>{e instanceof $r&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())});let{scene:d,camera:f}=Rd({model:i,background:l,keylight:a,fill:o,rim:s,glossiness:c,material:e,cameraState:n,aspect:1,enableShadows:!1});t.autoClear=!0,t.setRenderTarget(g),t.setScissor(0,0,Yf,Yf),t.setScissorTest(!1),t.render(d,f);let p=new Uint8Array(Yf*Yf*4);t.readRenderTargetPixels(g,0,0,Yf,Yf,p),ep(p,Yf);let m=tp(p,Yf);u.set(e,m),Xf.set(`${r}:${e}`,m),d.remove(i)}return i.traverse(e=>{e instanceof $r&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),g.dispose(),t.setRenderTarget(d),t.setViewport(p),t.setScissor(m),t.setScissorTest(h),t.autoClear=f,Zf=r,u}function $f(){Xf.clear(),Zf=null}function ep(e,t){let n=t*4,r=new Uint8Array(n);for(let i=0;i<t/2;i++){let a=i*n,o=(t-1-i)*n;r.set(e.slice(a,a+n)),e.copyWithin(a,o,o+n),e.set(r,o)}}function tp(e,t){let n=document.createElement(`canvas`);n.width=t,n.height=t;let r=n.getContext(`2d`),i=r.createImageData(t,t);return i.data.set(e),r.putImageData(i,0,0),n.toDataURL(`image/png`)}function np(){Xf.clear(),Zf=null}function rp(e){let t=yd(e),n=bd(),r=Fd(),i=Vd(r,e),{keyLight:a,fillLight:o,rimLight:s}=xd(n,{enableShadows:!0,keylight:Of(`keylight`),fill:Of(`fill`),rim:Of(`rim`)}),c=null;c=Wd(),n.add(c);function l(e){c&&n.remove(c),c=e,n.add(e),Ld(r,i,1),d()}function u(e=1){Ld(r,i,e)}let{requestRender:d,dispose:f}=Hd(t,n,r,i);i.addEventListener(`change`,()=>{d()}),d();function p(){let e=window.innerWidth,n=window.innerHeight;r.aspect=e/n,r.updateProjectionMatrix(),t.setSize(e,n),d()}window.addEventListener(`resize`,p);let m=window.matchMedia(`(prefers-color-scheme: dark)`);function h(){Td(n),d()}m.addEventListener(`change`,h);function g(){f(),i.dispose(),t.dispose(),window.removeEventListener(`resize`,p),m.removeEventListener(`change`,h)}return{renderer:t,scene:n,camera:r,controls:i,keyLight:a,fillLight:o,rimLight:s,resize:p,fitCamera:u,requestRender:d,dispose:g,setModel:l,getModel:()=>c}}var ip=Nf(),ap=ip&&ip.model&&ip.model.trim().length>0?ip.model:`skull.obj`;if(ip)for(let e of Tf){let t=ip.settings[e.id];t!==void 0&&kf(e.id,t)}var op=document.getElementById(`scene-canvas`);if(!op)throw Error(`Expected a <canvas id="scene-canvas"> element in the DOM`);var $=rp(op),sp=null,cp=null;af(ap).then(e=>{of(e,1),sp=ap,cp=e;let t=Of(`material`);t&&kd(e,t),zd(e,Of(`gloss`)),$.setModel(e),ip?.camera&&(df($.controls,$.camera,ip.camera),$.requestRender())}).catch(e=>{console.error(`[main] Failed to load model:`,e),cp=$.getModel()}).finally(()=>{lp()});function lp(){let e=new qf(n=>{t(n,e),n?($f(),m()):$f()},{controls:$.controls,camera:$.camera,fitCamera:$.fitCamera},sp??ap);function t(e,t){let n=window.innerWidth,r=window.innerHeight,i=n,a=0;if(e){let e=t.panelElement.offsetWidth;i=n-e,t.side===`left`&&(a=e)}$.camera.aspect=i/r,$.camera.updateProjectionMatrix(),$.renderer.setSize(i,r),op.style.left=a+`px`,$.requestRender()}window.removeEventListener(`resize`,$.resize);function n(){t(e.panelOpen,e)}window.addEventListener(`resize`,n),$.resize=n;let r=If(()=>sp,$.controls,$.camera);function i(){let e=Of(`keylight`);e&&(Sd($.keyLight,e),$.requestRender())}i();let a=Af(e=>{e===`keylight`&&i()});function o(){let e=Of(`fill`);e&&(Cd($.fillLight,e),$.requestRender())}o();let s=Af(e=>{e===`fill`&&o()});function c(){let e=Of(`rim`);e&&(wd($.rimLight,e),$.requestRender())}c();let l=Af(e=>{e===`rim`&&c()});function u(){cp&&(zd(cp,Of(`gloss`)),$.requestRender())}u();let d=Af(e=>{e===`gloss`&&u()});function f(){if(cp){let e=Of(`material`);e&&(kd(cp,e),$.requestRender())}}f();let p=Af(e=>{e===`material`&&f()});function m(){let e=uf($.controls,$.camera);Qf(sp,$.renderer,e).then(e=>{let t=document.querySelector(`[data-setting-id="material"]`);if(!t)return;let n=t._setThumbnail;if(n)for(let[t,r]of e)n(t,r)})}m();let h=$.dispose.bind($);$.dispose=()=>{r(),a(),s(),l(),d(),p(),np(),window.removeEventListener(`resize`,n),e.dispose(),h()}}export{ns as $,l as A,$r as B,Ne as C,Pi as D,Hi as E,ds as F,oo as G,lo as H,Mr as I,c as J,a as K,Ot as L,u as M,Be as N,qi as O,Io as P,ss as Q,q as R,_o as S,z as T,co as U,Vr as V,so as W,To as X,s as Y,wn as Z,ps as _,pr as _t,fr as a,Do as at,Or as b,Kt as bt,X as c,Nn as ct,Ho as d,di as dt,os as et,ls as f,yr as ft,Tn as g,qn as gt,hr as h,Uo as ht,Jn as i,kt as it,d as j,Ki as k,J as l,Ka as lt,zo as m,Gt as mt,Ao as n,Ji as nt,Dr as o,r as ot,sn as p,is as pt,o as q,fi as r,ks as rt,i as s,ze as st,us as t,$i as tt,da as u,gi as ut,_i as v,G as vt,Me as w,Ar as x,ko as xt,Ti as y,K as yt,Y as z};