const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FBXLoader-B2Bbu4M0.js","assets/fflate.module-BIQmJeC9.js","assets/3MFLoader-BdPPgaCj.js"])))=>i.map(i=>d[i]);
...
void main() {
    ...
    touch-action: none;
    user-select: none;
  `;let r=`http://www.w3.org/2000/svg`,i=document.createElementNS(r,`svg`);i.setAttribute(`viewBox`,`0 0 ${Qd} ${$d}`),i.setAttribute(`width`,String(Qd)),i.setAttribute(`height`,String($d)),i.style.display=`block`;let a=document.createElementNS(r,`circle`);a.setAttribute(`cx`,String(ef)),a.setAttribute(`cy`,String($d*.38)),a.setAttribute(`r`,String(tf)),a.setAttribute(`fill`,`none`),a.setAttribute(`stroke`,`var(--border)`),a.setAttribute(`stroke-width`,`2`),i.append(a);let o=document.createElementNS(r,`path`);o.setAttribute(`fill`,`none`),o.setAttribute(`stroke`,`var(--accent)`),o.setAttribute(`stroke-width`,`3`),o.setAttribute(`stroke-linecap`,`round`),i.append(o);let s=document.createElementNS(r,`path`);s.setAttribute(`fill`,`none`),s.setAttribute(`stroke`,`var(--border)`),s.setAttribute(`stroke-width`,`2`),i.append(s);let c=document.createElementNS(r,`path`);c.setAttribute(`fill`,`none`),c.setAttribute(`stroke`,`var(--accent)`),c.setAttribute(`stroke-width`,`3`),c.setAttribute(`stroke-linecap`,`round`),i.append(c);let l=document.createElementNS(r,`path`);l.setAttribute(`fill`,`none`),l.setAttribute(`stroke`,`var(--border)`),l.setAttribute(`stroke-width`,`2`),i.append(l);let u=document.createElementNS(r,`path`);u.setAttribute(`fill`,`none`),u.setAttribute(`stroke`,`var(--accent)`),u.setAttribute(`stroke-width`,`3`),u.setAttribute(`stroke-linecap`,`round`),i.append(u);let d=document.createElementNS(r,`text`);d.setAttribute(`x`,String(ef-tf-2)),d.setAttribute(`y`,`234.2`),d.setAttribute(`text-anchor`,`end`),d.setAttribute(`fill`,`var(--text-muted)`),d.setAttribute(`font-size`,`10`),d.setAttribute(`font-family`,`var(--font-sans)`),d.textContent=`◀`,i.append(d);let f=document.createElementNS(r,`text`);f.setAttribute(`x`,`182`),f.setAttribute(`y`,`234.2`),f.setAttribute(`text-anchor`,`start`),f.setAttribute(`fill`,`var(--text-muted)`),f.setAttribute(`font-size`,`10`),f.setAttribute(`font-family`,`var(--font-sans)`),f.textContent=`▶`,i.append(f);let p=document.createElementNS(r,`path`);p.setAttribute(`fill`,`none`),p.setAttribute(`stroke`,`var(--border)`),p.setAttribute(`stroke-width`,`2`),i.append(p);let m=document.createElementNS(r,`path`);m.setAttribute(`fill`,`none`),m.setAttribute(`stroke`,`var(--accent)`),m.setAttribute(`stroke-width`,`3`),m.setAttribute(`stroke-linecap`,`round`),i.append(m);let h=document.createElementNS(r,`text`);h.setAttribute(`x`,String(ef-tf-2)),h.setAttribute(`y`,`266.2`),h.setAttribute(`text-anchor`,`end`),h.setAttribute(`fill`,`var(--text-muted)`),h.setAttribute(`font-size`,`10`),h.setAttribute(`font-family`,`var(--font-sans)`),h.textContent=`◀`,i.append(h);let g=document.createElementNS(r,`text`);g.setAttribute(`x`,`182`),g.setAttribute(`y`,`266.2`),g.setAttribute(`text-anchor`,`start`),g.setAttribute(`fill`,`var(--text-muted)`),g.setAttribute(`font-size`,`10`),g.setAttribute(`font-family`,`var(--font-sans)`),g.textContent=`▶`,i.append(g);function _(e,t){let n=document.createElementNS(r,`text`);return n.setAttribute(`x`,String(ef)),n.setAttribute(`y`,String(t)),n.setAttribute(`text-anchor`,`middle`),n.setAttribute(`fill`,`var(--text-secondary)`),n.setAttribute(`font-size`,`9`),n.setAttribute(`font-family`,`var(--font-sans)`),n.setAttribute(`opacity`,`0.7`),n.textContent=e,i.append(n),n}_(`SOFTNESS`,218.2),_(`INTENSITY`,250.2);let v=document.createElementNS(r,`circle`);v.setAttribute(`r`,`8`),v.setAttribute(`fill`,`var(--accent)`),v.setAttribute(`stroke`,`#fff`),v.setAttribute(`stroke-width`,`2`),v.setAttribute(`cursor`,`grab`),i.append(v);let y=document.createElementNS(r,`circle`);y.setAttribute(`r`,`14`),y.setAttribute(`fill`,`none`),y.setAttribute(`stroke`,`var(--accent)`),y.setAttribute(`stroke-width`,`1`),y.setAttribute(`opacity`,`0.3`),i.append(y);let b=document.createElementNS(r,`circle`);b.setAttribute(`r`,String(rf)),b.setAttribute(`fill`,`var(--accent)`),b.setAttribute(`stroke`,`#fff`),b.setAttribute(`stroke-width`,`2`),b.setAttribute(`cursor`,`grab`),i.append(b);let x=document.createElementNS(r,`circle`);x.setAttribute(`r`,String(rf)),x.setAttribute(`fill`,`var(--accent-hover)`),x.setAttribute(`stroke`,`#fff`),x.setAttribute(`stroke-width`,`2`),x.setAttribute(`cursor`,`grab`),i.append(x);let S=document.createElementNS(r,`circle`);S.setAttribute(`r`,String(rf)),S.setAttribute(`fill`,`var(--accent-hover)`),S.setAttribute(`stroke`,`#fff`),S.setAttribute(`stroke-width`,`2`),S.setAttribute(`cursor`,`grab`),i.append(S);let C=document.createElementNS(r,`circle`);C.setAttribute(`r`,String(rf)),C.setAttribute(`fill`,`var(--accent-hover)`),C.setAttribute(`stroke`,`#fff`),C.setAttribute(`stroke-width`,`2`),C.setAttribute(`cursor`,`grab`),i.append(C);let w=document.createElement(`div`);w.style.cssText=`
    display: grid;
  ...
  `;function T(e){w.innerHTML=`
    ...
    `}n.append(i,w);let E=$d*.38;function D(e,t){let n=(e-90)*(Math.PI/180);return{x:ef+t*Math.cos(n),y:E+t*Math.sin(n)}}function O(e,t){let n=e-ef,r=t-E,i=180/Math.PI*Math.atan2(r,n)+90;return i<0&&(i+=360),i%360}function k(e){let t=(e+180)*(Math.PI/180);return{x:ef+nf*Math.cos(t),y:E+nf*Math.sin(t)}}function A(e,t){let n=e-ef,r=t-E,i=180/Math.PI*Math.atan2(r,n);return i<0&&(i+=360),i>=180&&i<=270?i-180:i<180?0:90}function ee(e,t){let n=e-ef,r=t-E,i=Math.sqrt(n*n+r*r),a=tf*.65;return(1-Math.min(a,Math.max(0,i))/a)*90}function te(e){return{x:ef-tf+e*2*tf,y:230.2}}function j(e){return(Math.min(180,Math.max(ef-tf,e))-(ef-tf))/(2*tf)}function ne(e){let t=Math.min(1,Math.max(0,e/5));return{x:ef-tf+t*2*tf,y:262.2}}function re(e){return(Math.min(180,Math.max(ef-tf,e))-(ef-tf))/(2*tf)*5}function M(e,t,n,r,i){if(Math.abs(i-r)<.01)return``;let a=(r-90)*(Math.PI/180),o=(i-90)*(Math.PI/180),s=e+n*Math.cos(a),c=t+n*Math.sin(a),l=e+n*Math.cos(o),u=t+n*Math.sin(o);return`M ${s} ${c} A ${n} ${n} 0 ${+(Math.abs(i-r)>180)} 1 ${l} ${u}`}function ie(e,t,n){return`M ${e} ${t} L ${n} ${t}`}function ae(e){o.setAttribute(`d`,e.azimuth>0?M(ef,E,tf,0,e.azimuth):``);let t=D(e.azimuth,tf);b.setAttribute(`cx`,String(t.x)),b.setAttribute(`cy`,String(t.y));let n=M(ef,E,nf,270,360);s.setAttribute(`d`,n),e.elevation>0?c.setAttribute(`d`,M(ef,E,nf,270,270+e.elevation)):c.setAttribute(`d`,``);let r=k(e.elevation);x.setAttribute(`cx`,String(r.x)),x.setAttribute(`cy`,String(r.y));let i=ef-tf,a=230.2;l.setAttribute(`d`,ie(i,a,180));let d=te(e.softness);u.setAttribute(`d`,ie(i,a,d.x)),S.setAttribute(`cx`,String(d.x)),S.setAttribute(`cy`,String(d.y));let f=262.2;p.setAttribute(`d`,ie(i,f,180));let h=ne(e.intensity);m.setAttribute(`d`,ie(i,f,h.x)),C.setAttribute(`cx`,String(h.x)),C.setAttribute(`cy`,String(h.y));let g=(e.azimuth-90)*(Math.PI/180),_=(1-e.elevation/90)*tf*.65,w=ef+_*Math.cos(g),O=E+_*Math.sin(g);v.setAttribute(`cx`,String(w)),v.setAttribute(`cy`,String(O)),y.setAttribute(`cx`,String(w)),y.setAttribute(`cy`,String(O)),T(e)}ae(e);let oe=null;function se(e,t){let n=i.getBoundingClientRect(),r=e-n.left,a=t-n.top,o=Qd/n.width,s=$d/n.height,c=r*o,l=a*s,u=c-ef,d=l-E,f=Math.sqrt(u*u+d*d);return Math.abs(l-230.2)<af*s*.4&&Math.abs(c-ef)<tf+af*o*.4?`softness`:Math.abs(l-262.2)<af*s*.4&&Math.abs(c-ef)<tf+af*o*.4?`intensity`:c<ef&&Math.abs(f-nf)<af*o*.5?`elevation`:Math.abs(f-tf)<af*o*.5?`azimuth`:f<tf+af*o*.3?`direction`:null}function N(e){e.preventDefault(),i.setPointerCapture(e.pointerId);let t=se(e.clientX,e.clientY);if(t){oe=t;let n=e.currentTarget;n.style.cursor=`grabbing`,P(e,t)}}function ce(e){oe&&(e.preventDefault(),P(e,oe))}function le(e){if(!oe)return;oe=null;let t=e.currentTarget;t.style.cursor=`default`,i.releasePointerCapture(e.pointerId)}function P(n,r){let a=i.getBoundingClientRect(),o=Qd/a.width,s=$d/a.height,c=(n.clientX-a.left)*o,l=(n.clientY-a.top)*s,u={...e};switch(r){case`azimuth`:u.azimuth=O(c,l);break;case`elevation`:u.elevation=A(c,l);break;case`softness`:u.softness=Math.min(1,Math.max(0,j(c)));break;case`intensity`:u.intensity=Math.min(5,Math.max(0,re(c)));break;case`direction`:u.azimuth=O(c,l),u.elevation=ee(c,l);break}e=u,ae(u),t(u)}return i.addEventListener(`pointerdown`,N),i.addEventListener(`pointermove`,ce),i.addEventListener(`pointerup`,le),i.addEventListener(`pointercancel`,le),n._updateLight=t=>{e=t,ae(t)},n._dispose=()=>{i.removeEventListener(`pointerdown`,N),i.removeEventListener(`pointermove`,ce),i.removeEventListener(`pointerup`,le),i.removeEventListener(`pointercancel`,le)},n}var sf=[`plaster`,`clay`,`bronze`,`chrome`],cf={plaster:{color:`#d8d6d0`,roughness:.95,metalness:0,materialClass:`standard`},clay:{color:`#9d7f68`,roughness:.95,metalness:0,materialClass:`standard`},bronze:{color:`#8b5a2b`,roughness:.35,metalness:1,materialClass:`physical`},"matte-black":{color:`#111111`,roughness:1,metalness:0,materialClass:`standard`},chrome:{color:`#ffffff`,roughness:0,metalness:.9,materialClass:`physical`}};function lf(e){return cf[e]}function uf(e,t){let n=lf(t);e.traverse(e=>{if(e instanceof $r){let t=df(n,e);Array.isArray(e.material)?e.material=e.material.map(()=>t.clone()):e.material=t,e.material.needsUpdate=!0}})}function df(e,t){let n={color:e.color,roughness:e.roughness,metalness:e.metalness},r=t.material,i=Array.isArray(r)?r[0]:r;switch(i instanceof oo&&(i.vertexColors&&(n.vertexColors=!0),i.map&&(n.map=i.map),i.side!==0&&(n.side=i.side),i.transparent&&(n.transparent=!0,n.opacity=i.opacity??1)),e.materialClass){case`physical`:return new so(n);default:return new oo(n)}}function ff(e){return e===null?`plaster`:sf.includes(e)?e:`plaster`}function pf(e){switch(e){case`plaster`:return`Plaster`;case`clay`:return`Clay`;case`bronze`:return`Bronze`;case`matte-black`:return`Matte Black`;case`chrome`:return`Chrome`}}var mf={id:`material`,label:`Material`,type:`material-preset`,defaultValue:`plaster`,serialize:e=>e,deserialize:e=>ff(e),createControl(e,t){let n=document.createElement(`div`);n.className=`material-preset-grid`;for(let e of sf){let r=document.createElement(`button`);r.className=`material-preset-card`,r.dataset.preset=e,r.type=`button`;let i=document.createElement(`div`);i.className=`material-preset-preview`;let a=document.createElement(`span`);a.className=`material-preset-label`,a.textContent=pf(e),r.append(i,a),r.addEventListener(`click`,()=>{t(e)}),n.append(r)}return hf(n,e),n._setThumbnail=(e,t)=>{let r=n.querySelector(`[data-preset="${e}"]`);if(!r)return;let i=r.querySelector(`.material-preset-preview`);i&&(i.style.backgroundImage=`url(${t})`,i.classList.add(`has-thumbnail`))},n._selectPreset=e=>{hf(n,e)},n}};function hf(e,t){let n=e.querySelectorAll(`.material-preset-card`);for(let e of n){let n=e.dataset.preset===t;e.classList.toggle(`is-selected`,n)}}var gf={id:`btn`,label:`Button Position`,type:`select`,defaultValue:`tl`,serialize:e=>e,deserialize:e=>e===`tl`||e===`tr`||e===`bl`||e===`br`?e:`tl`,createControl(e,t){let n=document.createElement(`select`);for(let[e,t]of[[`tl`,`Top Left`],[`tr`,`Top Right`],[`bl`,`Bottom Left`],[`br`,`Bottom Right`]]){let r=document.createElement(`option`);r.value=e,r.textContent=t,n.append(r)}return n.value=e,n.onchange=()=>t(n.value),n}};function _f(e,t,n){return Math.min(n,Math.max(t,e))}var vf={id:`keylight`,label:`Key Light`,type:`light`,defaultValue:{azimuth:45,elevation:30,intensity:1,softness:.5},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...vf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...vf.defaultValue}:{azimuth:_f(t[0],0,360),elevation:_f(t[1],0,90),intensity:_f(t[2],0,5),softness:_f(t[3],0,1)}},createControl(e,t){return of(e,t)}},yf={id:`fill`,label:`Fill Light`,type:`light`,defaultValue:{azimuth:225,elevation:20,intensity:.4,softness:0},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...yf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...yf.defaultValue}:{azimuth:_f(t[0],0,360),elevation:_f(t[1],0,90),intensity:_f(t[2],0,5),softness:_f(t[3],0,1)}},createControl(e,t){return of(e,t)}},bf={id:`rim`,label:`Back Light`,type:`light`,defaultValue:{azimuth:180,elevation:30,intensity:.3,softness:0},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...bf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...bf.defaultValue}:{azimuth:_f(t[0],0,360),elevation:_f(t[1],0,90),intensity:_f(t[2],0,5),softness:_f(t[3],0,1)}},createControl(e,t){return of(e,t)}},xf=[gf,{id:`gloss`,label:`Glossiness`,type:`number`,defaultValue:.6,serialize:e=>String(e),deserialize:e=>{if(e===null)return .6;let t=parseFloat(e);return isNaN(t)?.6:Math.min(1,Math.max(0,t))},createControl(e,t){let n=document.createElement(`div`);n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      min-height: 44px;
    ...
    `;let i=document.createElement(`span`);return i.style.cssText=`
      ...
      min-width: 28px;
      text-align: right;
    `,i.textContent=e.toFixed(2),r.oninput=()=>{let e=parseFloat(r.value);i.textContent=e.toFixed(2),t(e)},n.append(r,i),n}},mf,vf,yf,bf],Sf={};for(let e of xf)Sf[e.id]=e.defaultValue;var Cf=new Set;function wf(e){return Sf[e]}function Tf(e,t){Sf[e]=t;for(let n of Cf)n(e,t)}function Ef(e){return Cf.add(e),()=>{Cf.delete(e)}}var Df=1;function Of(e,t,n){let r=new URLSearchParams;r.set(`v`,String(Df)),e&&e.length>0&&r.set(`model`,e);let i=Xd(t,n);r.set(`cam`,`${i.theta},${i.phi},${i.radius}`);for(let e of xf){let t=wf(e.id);t!==e.defaultValue&&r.set(e.id,e.serialize(t))}return r.toString()}function kf(e){let t=new URLSearchParams(e??window.location.search),n=t.get(`v`);if(n===null)return{version:Df,model:null,camera:null,settings:{}};let r=parseInt(n,10);if(isNaN(r)||r!==1)return null;let i=t.get(`model`)||null,a=null,o=t.get(`cam`);if(o){let e=o.split(`,`).map(e=>e.trim()).map(Number);e.length===3&&e.every(e=>!isNaN(e))&&(a={theta:e[0],phi:e[1],radius:e[2]})}let s={};for(let e of xf)s[e.id]=e.deserialize(t.get(e.id));return{version:r,model:i,camera:a,settings:s}}function Af(e,t){let n=null;function r(...r){n!==null&&clearTimeout(n),n=setTimeout(()=>{n=null,e(...r)},t)}function i(){n!==null&&(clearTimeout(n),n=null)}return{call:r,cancel:i}}function jf(e,t,n){let r=Of(e,t,n),i=r.length>0?`?${r}`:window.location.pathname;history.pushState(null,``,i)}function Mf(e,t,n){let r=Af(()=>{jf(e(),t,n)},300),i=Ef(()=>{r.call()}),a=()=>{r.call()};return t.addEventListener(`change`,a),function(){i(),t.removeEventListener(`change`,a),r.cancel()}}function Nf(){let e=document.createDocumentFragment();for(let t of xf){let n=wf(t.id),r=document.createElement(`div`);r.className=`settings-row`;let i=document.createElement(`label`);i.className=`settings-label`,i.textContent=t.label;let a=t.createControl(n,e=>{Tf(t.id,e)});a.dataset.settingId=t.id,a.className=`${a.className||``} settings-control`.trim(),r.append(i,a),e.append(r)}return e}var Pf=`<svg width="22" height="22" viewBox="0 0 24 24" fill="none"
  ...
  </svg>`;function Ff(e){let t=document.createElement(`button`);return t.id=`settings-toggle`,t.className=`settings-toggle`,t.setAttribute(`aria-label`,`Toggle settings panel`),t.innerHTML=Pf,t.addEventListener(`click`,e),t}var If={keylight:{azimuth:45,elevation:30,intensity:1,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}},Lf=[{label:`Front`,theta:0,phi:0,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}}},{label:`Side`,theta:90,phi:0,lights:{keylight:{azimuth:315,elevation:30,intensity:1.2,softness:.5},fill:{azimuth:135,elevation:15,intensity:.4,softness:0},rim:{azimuth:90,elevation:35,intensity:.4,softness:0}}},{label:`Three Quarter`,theta:45,phi:30,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:35,intensity:.4,softness:0}}},{label:`Top`,theta:0,phi:90,lights:{keylight:{azimuth:45,elevation:60,intensity:1,softness:.5},fill:{azimuth:225,elevation:45,intensity:.3,softness:0},rim:{azimuth:180,elevation:10,intensity:.3,softness:0}}}];function Rf(e){Tf(`keylight`,{...e.keylight}),Tf(`fill`,{...e.fill}),Tf(`rim`,{...e.rim})}function zf(){Tf(`keylight`,{...If.keylight}),Tf(`fill`,{...If.fill}),Tf(`rim`,{...If.rim})}function Bf(e,t,n){let r=document.createElement(`div`);r.className=`view-presets`;let i=document.createElement(`span`);i.className=`settings-label`,i.textContent=`View Presets`,r.append(i);let a=document.createElement(`div`);a.className=`view-presets-grid`;for(let n of Lf){let r=document.createElement(`button`);r.className=`view-preset-btn`,r.textContent=n.label,r.addEventListener(`click`,()=>{let r=Xd(e,t);Zd(e,t,{theta:n.theta,phi:n.phi,radius:r.radius}),n.lights&&Rf(n.lights)}),a.append(r)}let o=document.createElement(`button`);return o.className=`view-preset-btn view-preset-btn--reset`,o.textContent=`Reset`,o.addEventListener(`click`,()=>{n(1),zf()}),a.append(o),r.append(a),r}var Vf=class{button;panel;isOpen=!1;unsub=null;currentSide=`left`;onToggle;viewerControls;constructor(e,t){this.onToggle=e??null,this.button=Ff(()=>this.toggle()),this.panel=document.createElement(`aside`),this.panel.id=`settings-panel`,this.panel.className=`settings-panel`,this.viewerControls=t??null,this.populatePanel(),document.body.append(this.panel,this.button),this.onKeyDown=this.onKeyDown.bind(this),document.addEventListener(`keydown`,this.onKeyDown);let n=wf(`btn`)??`tl`;this.applyPosition(n),this.unsub=Ef((e,t)=>{e===`btn`&&(this.applyPosition(t),this.isOpen&&this.onToggle?.(!0));let n=this.panel.querySelector(`[data-setting-id="${e}"]`);if(n){let e=n._updateLight;if(e){e(t);return}let r=n._selectPreset;if(r){r(t);return}`value`in n&&(n.value=String(t))}})}get panelElement(){return this.panel}get side(){return this.currentSide}get panelOpen(){return this.isOpen}applyPosition(e){this.button.dataset.corner=e,this.panel.dataset.corner=e,this.currentSide=e===`tl`||e===`bl`?`left`:`right`,this.panel.dataset.side=this.currentSide}toggle(){this.isOpen?this.close():this.open()}open(){this.isOpen||(this.isOpen=!0,this.button.classList.add(`is-active`),this.panel.classList.add(`is-open`),this.onToggle?.(!0))}close(){this.isOpen&&(this.isOpen=!1,this.button.classList.remove(`is-active`),this.panel.classList.remove(`is-open`),this.onToggle?.(!1))}onKeyDown(e){e.key===`Escape`&&this.isOpen&&this.close()}populatePanel(){if(this.panel.append(Nf()),this.viewerControls){let e=Bf(this.viewerControls.controls,this.viewerControls.camera,this.viewerControls.fitCamera);this.panel.append(e)}}dispose(){document.removeEventListener(`keydown`,this.onKeyDown),this.unsub&&this.unsub(),this.button.remove(),this.panel.remove()}},Hf=120,Uf=16777215;function Wf(e=1,t){let n=new ns(40,e,.1,20),r=t===void 0?Math.PI/180*45:t.theta*(Math.PI/180),i=t===void 0?Math.PI/180*30:t.phi*(Math.PI/180),a=t===void 0?3.5:t.radius;return n.position.set(a*Math.cos(i)*Math.sin(r),a*Math.sin(i),a*Math.cos(i)*Math.cos(r)),n.lookAt(0,0,0),n}function Gf(){let e=[],t=new ls(16777215,3.5),n=Math.PI/180*45,r=Math.PI/180*45;t.position.set(5*Math.cos(r)*Math.sin(n),5*Math.sin(r),5*Math.cos(r)*Math.cos(n)),e.push(t);let i=new ls(16777215,.4);i.position.set(-3,1,-2),e.push(i);let a=new us(16777215,.5);return e.push(a),e}var Kf=new Map,qf=null;async function Jf(e,t,n){let r=e??`__fallback__`;if(qf===r){let e=new Map;for(let t of sf){let n=Kf.get(`${r}:${t}`);n&&e.set(t,n)}if(e.size===sf.length)return e}await new Promise(e=>setTimeout(e,0));let i;i=e?await Gd(e):jd(),Kd(i,1);let a=new Map,o=t.getRenderTarget(),s=t.autoClear,c=new J;t.getViewport(c);let l=new J;t.getScissor(l);let u=t.getScissorTest(),d=new Jt(Hf,Hf),f=new Nn;f.background=new X(Uf);let p=Wf(1,n),m=Gf();for(let e of m)f.add(e);f.add(i);for(let e of sf){let n=lf(e);i.traverse(e=>{e instanceof $r&&e.material&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),i.traverse(e=>{e instanceof $r&&(e.material=df(n,e))}),t.autoClear=!0,t.setRenderTarget(d),t.setViewport(0,0,Hf,Hf),t.setScissor(0,0,Hf,Hf),t.setScissorTest(!1),t.render(f,p);let o=new Uint8Array(Hf*Hf*4);t.readRenderTargetPixels(d,0,0,Hf,Hf,o),Xf(o,Hf);let s=Zf(o,Hf);a.set(e,s),Kf.set(`${r}:${e}`,s)}return f.remove(i),i.traverse(e=>{e instanceof $r&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),f.clear(),d.dispose(),t.setRenderTarget(o),t.setViewport(c),t.setScissor(l),t.setScissorTest(u),t.autoClear=s,qf=r,a}function Yf(){Kf.clear(),qf=null}function Xf(e,t){let n=t*4,r=new Uint8Array(n);for(let i=0;i<t/2;i++){let a=i*n,o=(t-1-i)*n;r.set(e.slice(a,a+n)),e.copyWithin(a,o,o+n),e.set(r,o)}}function Zf(e,t){let n=document.createElement(`canvas`);n.width=t,n.height=t;let r=n.getContext(`2d`),i=r.createImageData(t,t);return i.data.set(e),r.putImageData(i,0,0),n.toDataURL(`image/png`)}function Qf(){Kf.clear(),qf=null}function $f(e){let t=yd(e),n=bd(),r=Ed(),i=Od(r,e),{keyLight:a,fillLight:o,rimLight:s}=xd(n),c=null;c=jd(),n.add(c);function l(e){c&&n.remove(c),c=e,n.add(e),Dd(r,i,1),d()}function u(e=1){Dd(r,i,e)}let{requestRender:d,dispose:f}=kd(t,n,r,i);i.addEventListener(`change`,()=>{d()}),d();function p(){let e=window.innerWidth,n=window.innerHeight;r.aspect=e/n,r.updateProjectionMatrix(),t.setSize(e,n),d()}window.addEventListener(`resize`,p);let m=window.matchMedia(`(prefers-color-scheme: dark)`);function h(){Td(n),d()}m.addEventListener(`change`,h);function g(){f(),i.dispose(),t.dispose(),window.removeEventListener(`resize`,p),m.removeEventListener(`change`,h)}return{renderer:t,scene:n,camera:r,controls:i,keyLight:a,fillLight:o,rimLight:s,resize:p,fitCamera:u,requestRender:d,dispose:g,setModel:l,getModel:()=>c}}var ep=kf(),tp=ep&&ep.model&&ep.model.trim().length>0?ep.model:`skull3.obj`;if(ep)for(let e of xf){let t=ep.settings[e.id];t!==void 0&&Tf(e.id,t)}var np=document.getElementById(`scene-canvas`);if(!np)throw Error(`Expected a <canvas id="scene-canvas"> element in the DOM`);var $=$f(np),rp=null,ip=null;function ap(e){let t=wf(`gloss`),n=1-t;e.traverse(e=>{if(!(e instanceof $r))return;let r=Array.isArray(e.material)?e.material:[e.material];for(let e of r)op(e,n,t)})}function op(e,t,n){e instanceof oo||e instanceof so?e.roughness=t:e instanceof co&&(e.shininess=Math.round(n*100))}Gd(tp).then(e=>{Kd(e,1),rp=tp,ip=e;let t=wf(`material`);t&&uf(e,t),ap(e),$.setModel(e),ep?.camera&&(Zd($.controls,$.camera,ep.camera),$.requestRender())}).catch(e=>{console.error(`[main] Failed to load model:`,e),ip=$.getModel()}).finally(()=>{sp()});function sp(){let e=new Vf(n=>{t(n,e),n?(Yf(),m()):Yf()},{controls:$.controls,camera:$.camera,fitCamera:$.fitCamera});function t(e,t){let n=window.innerWidth,r=window.innerHeight,i=n,a=0;if(e){let e=t.panelElement.offsetWidth;i=n-e,t.side===`left`&&(a=e)}$.camera.aspect=i/r,$.camera.updateProjectionMatrix(),$.renderer.setSize(i,r),np.style.left=a+`px`,$.requestRender()}window.removeEventListener(`resize`,$.resize);function n(){t(e.panelOpen,e)}window.addEventListener(`resize`,n),$.resize=n;let r=Mf(()=>rp,$.controls,$.camera);function i(){let e=wf(`keylight`);e&&(Sd($.keyLight,e),$.requestRender())}i();let a=Ef(e=>{e===`keylight`&&i()});function o(){let e=wf(`fill`);e&&(Cd($.fillLight,e),$.requestRender())}o();let s=Ef(e=>{e===`fill`&&o()});function c(){let e=wf(`rim`);e&&(wd($.rimLight,e),$.requestRender())}c();let l=Ef(e=>{e===`rim`&&c()});function u(){ip&&(ap(ip),$.requestRender())}u();let d=Ef(e=>{e===`gloss`&&u()});function f(){if(ip){let e=wf(`material`);e&&(uf(ip,e),$.requestRender())}}f();let p=Ef(e=>{e===`material`&&f()});function m(){let e=Xd($.controls,$.camera);Jf(rp,$.renderer,e).then(e=>{let t=document.querySelector(`[data-setting-id="material"]`);if(!t)return;let n=t._setThumbnail;if(n)for(let[t,r]of e)n(t,r)})}m();let h=$.dispose.bind($);$.dispose=()=>{r(),a(),s(),l(),d(),p(),Qf(),window.removeEventListener(`resize`,n),e.dispose(),h()}}export{ns as $,l as A,$r as B,Pe as C,Pi as D,Hi as E,ds as F,oo as G,lo as H,Mr as I,c as J,a as K,kt as L,u as M,Ve as N,qi as O,Io as P,ss as Q,K as R,_o as S,R as T,co as U,Vr as V,so as W,To as X,s as Y,wn as Z,ps as _,pr as _t,fr as a,Do as at,Or as b,J as bt,X as c,Nn as ct,Ho as d,di as dt,os as et,ls as f,yr as ft,Tn as g,qn as gt,hr as h,Uo as ht,Jn as i,At as it,d as j,Ki as k,q as l,Ka as lt,zo as m,Kt as mt,Ao as n,Ji as nt,Dr as o,r as ot,sn as p,is as pt,o as q,fi as r,ks as rt,i as s,Be as st,us as t,$i as tt,da as u,gi as ut,_i as v,W as vt,Ne as w,Ar as x,ko as xt,Ti as y,G as yt,Y as z};