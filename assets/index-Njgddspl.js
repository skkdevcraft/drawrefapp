const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FBXLoader-Bxxegno4.js","assets/fflate.module-BIQmJeC9.js","assets/3MFLoader-BX42pz-0.js"])))=>i.map(i=>d[i]);
...
void main() {
    ...
    touch-action: none;
    user-select: none;
  `;let r=`http://www.w3.org/2000/svg`,i=document.createElementNS(r,`svg`);i.setAttribute(`viewBox`,`0 0 ${ff} ${pf}`),i.setAttribute(`width`,String(ff)),i.setAttribute(`height`,String(pf)),i.style.display=`block`;let a=document.createElementNS(r,`circle`);a.setAttribute(`cx`,String(mf)),a.setAttribute(`cy`,String(pf*.38)),a.setAttribute(`r`,String(hf)),a.setAttribute(`fill`,`none`),a.setAttribute(`stroke`,`var(--border)`),a.setAttribute(`stroke-width`,`2`),i.append(a);let o=document.createElementNS(r,`path`);o.setAttribute(`fill`,`none`),o.setAttribute(`stroke`,`var(--accent)`),o.setAttribute(`stroke-width`,`3`),o.setAttribute(`stroke-linecap`,`round`),i.append(o);let s=document.createElementNS(r,`path`);s.setAttribute(`fill`,`none`),s.setAttribute(`stroke`,`var(--border)`),s.setAttribute(`stroke-width`,`2`),i.append(s);let c=document.createElementNS(r,`path`);c.setAttribute(`fill`,`none`),c.setAttribute(`stroke`,`var(--accent)`),c.setAttribute(`stroke-width`,`3`),c.setAttribute(`stroke-linecap`,`round`),i.append(c);let l=document.createElementNS(r,`path`);l.setAttribute(`fill`,`none`),l.setAttribute(`stroke`,`var(--border)`),l.setAttribute(`stroke-width`,`2`),i.append(l);let u=document.createElementNS(r,`path`);u.setAttribute(`fill`,`none`),u.setAttribute(`stroke`,`var(--accent)`),u.setAttribute(`stroke-width`,`3`),u.setAttribute(`stroke-linecap`,`round`),i.append(u);let d=document.createElementNS(r,`text`);d.setAttribute(`x`,String(mf-hf-2)),d.setAttribute(`y`,`234.2`),d.setAttribute(`text-anchor`,`end`),d.setAttribute(`fill`,`var(--text-muted)`),d.setAttribute(`font-size`,`10`),d.setAttribute(`font-family`,`var(--font-sans)`),d.textContent=`◀`,i.append(d);let f=document.createElementNS(r,`text`);f.setAttribute(`x`,`182`),f.setAttribute(`y`,`234.2`),f.setAttribute(`text-anchor`,`start`),f.setAttribute(`fill`,`var(--text-muted)`),f.setAttribute(`font-size`,`10`),f.setAttribute(`font-family`,`var(--font-sans)`),f.textContent=`▶`,i.append(f);let p=document.createElementNS(r,`path`);p.setAttribute(`fill`,`none`),p.setAttribute(`stroke`,`var(--border)`),p.setAttribute(`stroke-width`,`2`),i.append(p);let m=document.createElementNS(r,`path`);m.setAttribute(`fill`,`none`),m.setAttribute(`stroke`,`var(--accent)`),m.setAttribute(`stroke-width`,`3`),m.setAttribute(`stroke-linecap`,`round`),i.append(m);let h=document.createElementNS(r,`text`);h.setAttribute(`x`,String(mf-hf-2)),h.setAttribute(`y`,`266.2`),h.setAttribute(`text-anchor`,`end`),h.setAttribute(`fill`,`var(--text-muted)`),h.setAttribute(`font-size`,`10`),h.setAttribute(`font-family`,`var(--font-sans)`),h.textContent=`◀`,i.append(h);let g=document.createElementNS(r,`text`);g.setAttribute(`x`,`182`),g.setAttribute(`y`,`266.2`),g.setAttribute(`text-anchor`,`start`),g.setAttribute(`fill`,`var(--text-muted)`),g.setAttribute(`font-size`,`10`),g.setAttribute(`font-family`,`var(--font-sans)`),g.textContent=`▶`,i.append(g);function _(e,t){let n=document.createElementNS(r,`text`);return n.setAttribute(`x`,String(mf)),n.setAttribute(`y`,String(t)),n.setAttribute(`text-anchor`,`middle`),n.setAttribute(`fill`,`var(--text-secondary)`),n.setAttribute(`font-size`,`9`),n.setAttribute(`font-family`,`var(--font-sans)`),n.setAttribute(`opacity`,`0.7`),n.textContent=e,i.append(n),n}_(`SOFTNESS`,218.2),_(`INTENSITY`,250.2);let v=document.createElementNS(r,`circle`);v.setAttribute(`r`,`8`),v.setAttribute(`fill`,`var(--accent)`),v.setAttribute(`stroke`,`#fff`),v.setAttribute(`stroke-width`,`2`),v.setAttribute(`cursor`,`grab`),i.append(v);let y=document.createElementNS(r,`circle`);y.setAttribute(`r`,`14`),y.setAttribute(`fill`,`none`),y.setAttribute(`stroke`,`var(--accent)`),y.setAttribute(`stroke-width`,`1`),y.setAttribute(`opacity`,`0.3`),i.append(y);let b=document.createElementNS(r,`circle`);b.setAttribute(`r`,String(_f)),b.setAttribute(`fill`,`var(--accent)`),b.setAttribute(`stroke`,`#fff`),b.setAttribute(`stroke-width`,`2`),b.setAttribute(`cursor`,`grab`),i.append(b);let x=document.createElementNS(r,`circle`);x.setAttribute(`r`,String(_f)),x.setAttribute(`fill`,`var(--accent-hover)`),x.setAttribute(`stroke`,`#fff`),x.setAttribute(`stroke-width`,`2`),x.setAttribute(`cursor`,`grab`),i.append(x);let S=document.createElementNS(r,`circle`);S.setAttribute(`r`,String(_f)),S.setAttribute(`fill`,`var(--accent-hover)`),S.setAttribute(`stroke`,`#fff`),S.setAttribute(`stroke-width`,`2`),S.setAttribute(`cursor`,`grab`),i.append(S);let C=document.createElementNS(r,`circle`);C.setAttribute(`r`,String(_f)),C.setAttribute(`fill`,`var(--accent-hover)`),C.setAttribute(`stroke`,`#fff`),C.setAttribute(`stroke-width`,`2`),C.setAttribute(`cursor`,`grab`),i.append(C);let w=document.createElement(`div`);w.style.cssText=`
    display: grid;
  ...
  `;function T(e){w.innerHTML=`
    ...
    `}n.append(i,w);let E=pf*.38;function D(e,t){let n=(e-90)*(Math.PI/180);return{x:mf+t*Math.cos(n),y:E+t*Math.sin(n)}}function O(e,t){let n=e-mf,r=t-E,i=180/Math.PI*Math.atan2(r,n)+90;return i<0&&(i+=360),i%360}function k(e){let t=(e+180)*(Math.PI/180);return{x:mf+gf*Math.cos(t),y:E+gf*Math.sin(t)}}function A(e,t){let n=e-mf,r=t-E,i=180/Math.PI*Math.atan2(r,n);return i<0&&(i+=360),i>=180&&i<=270?i-180:i<180?0:90}function ee(e,t){let n=e-mf,r=t-E,i=Math.sqrt(n*n+r*r),a=hf*.65;return(1-Math.min(a,Math.max(0,i))/a)*90}function te(e){return{x:mf-hf+e*2*hf,y:230.2}}function j(e){return(Math.min(180,Math.max(mf-hf,e))-(mf-hf))/(2*hf)}function ne(e){let t=Math.min(1,Math.max(0,e/5));return{x:mf-hf+t*2*hf,y:262.2}}function re(e){return(Math.min(180,Math.max(mf-hf,e))-(mf-hf))/(2*hf)*5}function M(e,t,n,r,i){if(Math.abs(i-r)<.01)return``;let a=(r-90)*(Math.PI/180),o=(i-90)*(Math.PI/180),s=e+n*Math.cos(a),c=t+n*Math.sin(a),l=e+n*Math.cos(o),u=t+n*Math.sin(o);return`M ${s} ${c} A ${n} ${n} 0 ${+(Math.abs(i-r)>180)} 1 ${l} ${u}`}function ie(e,t,n){return`M ${e} ${t} L ${n} ${t}`}function ae(e){o.setAttribute(`d`,e.azimuth>0?M(mf,E,hf,0,e.azimuth):``);let t=D(e.azimuth,hf);b.setAttribute(`cx`,String(t.x)),b.setAttribute(`cy`,String(t.y));let n=M(mf,E,gf,270,360);s.setAttribute(`d`,n),e.elevation>0?c.setAttribute(`d`,M(mf,E,gf,270,270+e.elevation)):c.setAttribute(`d`,``);let r=k(e.elevation);x.setAttribute(`cx`,String(r.x)),x.setAttribute(`cy`,String(r.y));let i=mf-hf,a=230.2;l.setAttribute(`d`,ie(i,a,180));let d=te(e.softness);u.setAttribute(`d`,ie(i,a,d.x)),S.setAttribute(`cx`,String(d.x)),S.setAttribute(`cy`,String(d.y));let f=262.2;p.setAttribute(`d`,ie(i,f,180));let h=ne(e.intensity);m.setAttribute(`d`,ie(i,f,h.x)),C.setAttribute(`cx`,String(h.x)),C.setAttribute(`cy`,String(h.y));let g=(e.azimuth-90)*(Math.PI/180),_=(1-e.elevation/90)*hf*.65,w=mf+_*Math.cos(g),O=E+_*Math.sin(g);v.setAttribute(`cx`,String(w)),v.setAttribute(`cy`,String(O)),y.setAttribute(`cx`,String(w)),y.setAttribute(`cy`,String(O)),T(e)}ae(e);let oe=null;function se(e,t){let n=i.getBoundingClientRect(),r=e-n.left,a=t-n.top,o=ff/n.width,s=pf/n.height,c=r*o,l=a*s,u=c-mf,d=l-E,f=Math.sqrt(u*u+d*d);return Math.abs(l-230.2)<vf*s*.4&&Math.abs(c-mf)<hf+vf*o*.4?`softness`:Math.abs(l-262.2)<vf*s*.4&&Math.abs(c-mf)<hf+vf*o*.4?`intensity`:c<mf&&Math.abs(f-gf)<vf*o*.5?`elevation`:Math.abs(f-hf)<vf*o*.5?`azimuth`:f<hf+vf*o*.3?`direction`:null}function N(e){e.preventDefault(),i.setPointerCapture(e.pointerId);let t=se(e.clientX,e.clientY);if(t){oe=t;let n=e.currentTarget;n.style.cursor=`grabbing`,P(e,t)}}function ce(e){oe&&(e.preventDefault(),P(e,oe))}function le(e){if(!oe)return;oe=null;let t=e.currentTarget;t.style.cursor=`default`,i.releasePointerCapture(e.pointerId)}function P(n,r){let a=i.getBoundingClientRect(),o=ff/a.width,s=pf/a.height,c=(n.clientX-a.left)*o,l=(n.clientY-a.top)*s,u={...e};switch(r){case`azimuth`:u.azimuth=O(c,l);break;case`elevation`:u.elevation=A(c,l);break;case`softness`:u.softness=Math.min(1,Math.max(0,j(c)));break;case`intensity`:u.intensity=Math.min(5,Math.max(0,re(c)));break;case`direction`:u.azimuth=O(c,l),u.elevation=ee(c,l);break}e=u,ae(u),t(u)}return i.addEventListener(`pointerdown`,N),i.addEventListener(`pointermove`,ce),i.addEventListener(`pointerup`,le),i.addEventListener(`pointercancel`,le),n._updateLight=t=>{e=t,ae(t)},n._dispose=()=>{i.removeEventListener(`pointerdown`,N),i.removeEventListener(`pointermove`,ce),i.removeEventListener(`pointerup`,le),i.removeEventListener(`pointercancel`,le)},n}var bf=[[`tl`,`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="9" cy="9" r="4" fill="currentColor" stroke="none"/></svg>`],[`tr`,`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="15" cy="9" r="4" fill="currentColor" stroke="none"/></svg>`],[`bl`,`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="9" cy="15" r="4" fill="currentColor" stroke="none"/></svg>`],[`br`,`<svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><circle cx="15" cy="15" r="4" fill="currentColor" stroke="none"/></svg>`]],xf={id:`btn`,label:`Button Position`,type:`select`,defaultValue:`tr`,serialize:e=>e,deserialize:e=>e===`tl`||e===`tr`||e===`bl`||e===`br`?e:`tr`,createControl(e,t){let n=document.createElement(`div`);n.className=`button-position-grid`;let r=[];function i(e){for(let t of r)t.classList.toggle(`is-selected`,t.dataset.corner===e)}for(let[a,o]of bf){let s=document.createElement(`button`);s.type=`button`,s.className=`button-position-btn`,s.dataset.corner=a,s.setAttribute(`aria-label`,`Position buttons at ${a.replace(`tl`,`top-left`).replace(`tr`,`top-right`).replace(`bl`,`bottom-left`).replace(`br`,`bottom-right`)}`),s.innerHTML=o,a===e&&s.classList.add(`is-selected`),s.addEventListener(`click`,()=>{s.dataset.corner&&(i(s.dataset.corner),t(s.dataset.corner))}),n.append(s),r.push(s)}return n._selectButton=i,n}};function Sf(e,t,n){return Math.min(n,Math.max(t,e))}var Cf={id:`keylight`,label:`Key Light`,type:`light`,defaultValue:{azimuth:45,elevation:30,intensity:2.5,softness:.5},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...Cf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...Cf.defaultValue}:{azimuth:Sf(t[0],0,360),elevation:Sf(t[1],0,90),intensity:Sf(t[2],0,5),softness:Sf(t[3],0,1)}},createControl(e,t){return yf(e,t)}},wf={id:`fill`,label:`Fill Light`,type:`light`,defaultValue:{azimuth:225,elevation:20,intensity:.4,softness:0},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...wf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...wf.defaultValue}:{azimuth:Sf(t[0],0,360),elevation:Sf(t[1],0,90),intensity:Sf(t[2],0,5),softness:Sf(t[3],0,1)}},createControl(e,t){return yf(e,t)}},Tf={id:`rim`,label:`Back Light`,type:`light`,defaultValue:{azimuth:180,elevation:30,intensity:.3,softness:0},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...Tf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...Tf.defaultValue}:{azimuth:Sf(t[0],0,360),elevation:Sf(t[1],0,90),intensity:Sf(t[2],0,5),softness:Sf(t[3],0,1)}},createControl(e,t){return yf(e,t)}},Ef=[xf,{id:`bg`,label:`Background`,type:`color`,defaultValue:`#111111`,serialize:e=>e,deserialize:e=>typeof e==`string`&&/^#[0-9a-fA-F]{6}$/.test(e)?e:`#111111`,createControl(e,t){let n=document.createElement(`input`);return n.type=`color`,n.value=e,n.style.cssText=`
      width: 44px;
      height: 44px;
      padding: 4px;
    ...
    `;let i=document.createElement(`span`);return i.style.cssText=`
      ...
      min-width: 28px;
      text-align: right;
    `,i.textContent=e.toFixed(2),r.oninput=()=>{let e=parseFloat(r.value);i.textContent=e.toFixed(2),t(e)},n.append(r,i),n}},Nd,Cf,wf,Tf],Df={};for(let e of Ef)Df[e.id]=e.defaultValue;var Of=new Set;function kf(e){return Df[e]}function Af(e,t){Df[e]=t;for(let n of Of)n(e,t)}function jf(e){return Of.add(e),()=>{Of.delete(e)}}var Mf=1;function Nf(e,t,n){let r=new URLSearchParams;r.set(`v`,String(Mf)),e&&e.length>0&&r.set(`model`,e);let i=uf(t,n);r.set(`cam`,`${i.theta},${i.phi},${i.radius}`);for(let e of Ef){let t=kf(e.id);t!==e.defaultValue&&r.set(e.id,e.serialize(t))}return r.toString()}function Pf(e){let t=new URLSearchParams(e??window.location.search),n=t.get(`v`);if(n===null)return{version:Mf,model:null,camera:null,settings:{}};let r=parseInt(n,10);if(isNaN(r)||r!==1)return null;let i=t.get(`model`)||null,a=null,o=t.get(`cam`);if(o){let e=o.split(`,`).map(e=>e.trim()).map(Number);e.length===3&&e.every(e=>!isNaN(e))&&(a={theta:e[0],phi:e[1],radius:e[2]})}let s={};for(let e of Ef)s[e.id]=e.deserialize(t.get(e.id));return{version:r,model:i,camera:a,settings:s}}function Ff(e,t){let n=null;function r(...r){n!==null&&clearTimeout(n),n=setTimeout(()=>{n=null,e(...r)},t)}function i(){n!==null&&(clearTimeout(n),n=null)}return{call:r,cancel:i}}function If(e,t,n){let r=Nf(e,t,n),i=r.length>0?`?${r}`:window.location.pathname;history.pushState(null,``,i)}function Lf(e,t,n){let r=Ff(()=>{If(e(),t,n)},300),i=jf(()=>{r.call()}),a=()=>{r.call()};return t.addEventListener(`change`,a),function(){i(),t.removeEventListener(`change`,a),r.cancel()}}function Rf(){let e=document.createDocumentFragment();for(let t of Ef){let n=kf(t.id),r=document.createElement(`div`);r.className=`settings-row`;let i=document.createElement(`label`);i.className=`settings-label`,i.textContent=t.label;let a=t.createControl(n,e=>{Af(t.id,e)});a.dataset.settingId=t.id,a.className=`${a.className||``} settings-control`.trim(),r.append(i,a),e.append(r)}return e}var zf=`<svg width="22" height="22" viewBox="0 0 24 24" fill="none"
  ...
  </svg>`,Bf=`<svg width="22" height="22" viewBox="0 0 24 24" fill="none"
       stroke="currentColor" stroke-width="2" stroke-linecap="round"
       stroke-linejoin="round">
    <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/>
    <circle cx="12" cy="12" r="3"/>
  </svg>`,Vf=`<svg width="22" height="22" viewBox="0 0 24 24" fill="none"
       stroke="currentColor" stroke-width="2" stroke-linecap="round"
       stroke-linejoin="round">
    <path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/>
    <line x1="2" y1="12" x2="22" y2="12"/>
  </svg>`;function Hf(e){let t=document.createElement(`button`);return t.id=`settings-toggle`,t.className=`settings-toggle`,t.setAttribute(`aria-label`,`Toggle settings panel`),t.innerHTML=zf,t.addEventListener(`click`,e),t}function Uf(e){let t=document.createElement(`button`);return t.id=`eye-toggle`,t.className=`eye-toggle`,t.setAttribute(`aria-label`,`Toggle model visibility`),t.innerHTML=Bf,t.dataset.visible=`true`,t.addEventListener(`click`,e),t}var Wf={keylight:{azimuth:45,elevation:30,intensity:1,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}},Gf=[{label:`Front`,theta:0,phi:0,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}}},{label:`Side`,theta:90,phi:0,lights:{keylight:{azimuth:315,elevation:30,intensity:1.2,softness:.5},fill:{azimuth:135,elevation:15,intensity:.4,softness:0},rim:{azimuth:90,elevation:35,intensity:.4,softness:0}}},{label:`Three Quarter`,theta:45,phi:30,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:35,intensity:.4,softness:0}}},{label:`Top`,theta:0,phi:90,lights:{keylight:{azimuth:45,elevation:60,intensity:1,softness:.5},fill:{azimuth:225,elevation:45,intensity:.3,softness:0},rim:{azimuth:180,elevation:10,intensity:.3,softness:0}}}];function Kf(e){Af(`keylight`,{...e.keylight}),Af(`fill`,{...e.fill}),Af(`rim`,{...e.rim})}function qf(){Af(`keylight`,{...Wf.keylight}),Af(`fill`,{...Wf.fill}),Af(`rim`,{...Wf.rim})}function Jf(e,t,n){let r=document.createElement(`div`);r.className=`view-presets`;let i=document.createElement(`span`);i.className=`settings-label`,i.textContent=`View Presets`,r.append(i);let a=document.createElement(`div`);a.className=`view-presets-grid`;for(let n of Gf){let r=document.createElement(`button`);r.className=`view-preset-btn`,r.textContent=n.label,r.addEventListener(`click`,()=>{let r=uf(e,t);df(e,t,{theta:n.theta,phi:n.phi,radius:r.radius}),n.lights&&Kf(n.lights)}),a.append(r)}let o=document.createElement(`button`);return o.className=`view-preset-btn view-preset-btn--reset`,o.textContent=`Reset`,o.addEventListener(`click`,()=>{n(1),qf()}),a.append(o),r.append(a),r}var Yf={"skull.obj":{author:`deater07`,source:`https://free3d.com/3d-model/skull-human-anatomy-82445.html`},"head.obj":{author:`Ron lemen`,source:`Planes of the Head.blend`}};function Xf(e){return Yf[e]??null}var Zf=class{button;panel;isOpen=!1;unsub=null;currentSide=`left`;onToggle;viewerControls;modelName;constructor(e,t,n){this.modelName=n??null,this.onToggle=e??null,this.button=Hf(()=>this.toggle()),this.panel=document.createElement(`aside`),this.panel.id=`settings-panel`,this.panel.className=`settings-panel`,this.viewerControls=t??null,this.populatePanel(),document.body.append(this.panel,this.button),this.onKeyDown=this.onKeyDown.bind(this),document.addEventListener(`keydown`,this.onKeyDown);let r=kf(`btn`)??`tl`;this.applyPosition(r),this.unsub=jf((e,t)=>{e===`btn`&&(this.applyPosition(t),this.isOpen&&this.onToggle?.(!0));let n=this.panel.querySelector(`[data-setting-id="${e}"]`);if(n){let e=n._updateLight;if(e){e(t);return}let r=n._selectPreset;if(r){r(t);return}let i=n._selectButton;if(i){i(t);return}`value`in n&&(n.value=String(t))}})}get panelElement(){return this.panel}get side(){return this.currentSide}get panelOpen(){return this.isOpen}applyPosition(e){this.button.dataset.corner=e,this.panel.dataset.corner=e,this.currentSide=e===`tl`||e===`bl`?`left`:`right`,this.panel.dataset.side=this.currentSide}toggle(){this.isOpen?this.close():this.open()}open(){this.isOpen||(this.isOpen=!0,this.button.classList.add(`is-active`),this.panel.classList.add(`is-open`),this.onToggle?.(!0))}close(){this.isOpen&&(this.isOpen=!1,this.button.classList.remove(`is-active`),this.panel.classList.remove(`is-open`),this.onToggle?.(!1))}onKeyDown(e){e.key===`Escape`&&this.isOpen&&this.close()}setModelName(e){this.modelName=e,this.updateCredits()}creditsSection=null;renderCredits(){let e=document.createElement(`div`);if(e.className=`model-credits`,!this.modelName)return e.style.display=`none`,e;let t=Xf(this.modelName);if(!t)return e.style.display=`none`,e;let n=document.createElement(`div`);if(n.className=`credit-row`,n.innerHTML=`<span class="credit-label">Model</span><span class="credit-value credit-value--filename">${Qf(this.modelName)}</span>`,e.append(n),t.author){let n=document.createElement(`div`);n.className=`credit-row`,n.innerHTML=`<span class="credit-label">Author</span><span class="credit-value">${Qf(t.author)}</span>`,e.append(n)}if(t.source){let n=document.createElement(`div`);n.className=`credit-row`,/^https?:\/\//.test(t.source)?n.innerHTML=`<span class="credit-label">Source</span><a class="credit-value credit-value--link" href="${Qf(t.source)}" target="_blank" rel="noopener noreferrer">${Qf(t.source)}</a>`:n.innerHTML=`<span class="credit-label">Source</span><span class="credit-value">${Qf(t.source)}</span>`,e.append(n)}if(t.license){let n=document.createElement(`div`);n.className=`credit-row`,n.innerHTML=`<span class="credit-label">License</span><span class="credit-value">${Qf(t.license)}</span>`,e.append(n)}return e}updateCredits(){if(!this.creditsSection)return;let e=this.renderCredits();this.creditsSection.replaceWith(e),this.creditsSection=e}populatePanel(){if(this.panel.append(Rf()),this.viewerControls){let e=Jf(this.viewerControls.controls,this.viewerControls.camera,this.viewerControls.fitCamera);this.panel.append(e)}this.creditsSection=this.renderCredits(),this.panel.append(this.creditsSection)}dispose(){document.removeEventListener(`keydown`,this.onKeyDown),this.unsub&&this.unsub(),this.button.remove(),this.panel.remove()}};function Qf(e){let t=document.createElement(`span`);return t.textContent=e,t.innerHTML}var $f=120,ep=new Map,tp=null;async function np(e,t,n){let r=e??`__fallback__`;if(tp===r){let e=new Map;for(let t of Ed){let n=ep.get(`${r}:${t}`);n&&e.set(t,n)}if(e.size===Ed.length)return e}await new Promise(e=>setTimeout(e,0));let i;i=e?await af(e):Wd(),of(i,1);let a=kf(`keylight`),o=kf(`fill`),s=kf(`rim`),c=kf(`gloss`),l=kf(`ambient`),u=getComputedStyle(document.documentElement).getPropertyValue(`--bg-primary`).trim()||`#111111`,d=new Map,f=t.getRenderTarget(),p=t.autoClear,m=new J;t.getViewport(m);let h=new J;t.getScissor(h);let g=t.getScissorTest(),_=new Jt($f,$f);for(let e of Ed){i.traverse(e=>{e instanceof $r&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())});let{scene:f,camera:p}=Rd({model:i,background:u,ambient:l,keylight:a,fill:o,rim:s,glossiness:c,material:e,cameraState:n&&{...n,radius:n.radius*.8},aspect:1,enableShadows:!1});t.autoClear=!0,t.setRenderTarget(_),t.setScissor(0,0,$f,$f),t.setScissorTest(!1),t.render(f,p);let m=new Uint8Array($f*$f*4);t.readRenderTargetPixels(_,0,0,$f,$f,m),ip(m,$f);let h=ap(m,$f);d.set(e,h),ep.set(`${r}:${e}`,h),f.remove(i)}return i.traverse(e=>{e instanceof $r&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),_.dispose(),t.setRenderTarget(f),t.setViewport(m),t.setScissor(h),t.setScissorTest(g),t.autoClear=p,tp=r,d}function rp(){ep.clear(),tp=null}function ip(e,t){let n=t*4,r=new Uint8Array(n);for(let i=0;i<t/2;i++){let a=i*n,o=(t-1-i)*n;r.set(e.slice(a,a+n)),e.copyWithin(a,o,o+n),e.set(r,o)}}function ap(e,t){let n=document.createElement(`canvas`);n.width=t,n.height=t;let r=n.getContext(`2d`),i=r.createImageData(t,t);return i.data.set(e),r.putImageData(i,0,0),n.toDataURL(`image/png`)}function op(){ep.clear(),tp=null}function sp(e){let t=yd(e),n=bd(),r=Fd(),i=Vd(r,e),{ambientLight:a,keyLight:o,fillLight:s,rimLight:c}=xd(n,{enableShadows:!0,keylight:kf(`keylight`),fill:kf(`fill`),rim:kf(`rim`)}),l=null;l=Wd(),n.add(l);function u(e){l&&n.remove(l),l=e,n.add(e),Ld(r,i,1),f()}function d(e=1){Ld(r,i,e)}let{requestRender:f,dispose:p}=Hd(t,n,r,i);i.addEventListener(`change`,()=>{f()}),f();function m(){let e=window.innerWidth,n=window.innerHeight;r.aspect=e/n,r.updateProjectionMatrix(),t.setSize(e,n),f()}window.addEventListener(`resize`,m);function h(){p(),i.dispose(),t.dispose(),window.removeEventListener(`resize`,m)}return{renderer:t,scene:n,camera:r,controls:i,ambientLight:a,keyLight:o,fillLight:s,rimLight:c,resize:m,fitCamera:d,requestRender:f,dispose:h,setModel:u,getModel:()=>l}}var cp=Pf(),lp=cp&&cp.model&&cp.model.trim().length>0?cp.model:`skull.obj`;if(cp)for(let e of Ef){let t=cp.settings[e.id];t!==void 0&&Af(e.id,t)}var up=document.getElementById(`scene-canvas`);if(!up)throw Error(`Expected a <canvas id="scene-canvas"> element in the DOM`);var $=sp(up);{let e=kf(`bg`);e&&($.scene.background=new X(e)),$.requestRender()}var dp=null,fp=null;af(lp).then(e=>{of(e,1),dp=lp,fp=e;let t=kf(`material`);t&&kd(e,t),zd(e,kf(`gloss`)),$.setModel(e),cp?.camera&&(df($.controls,$.camera,cp.camera),$.requestRender())}).catch(e=>{console.error(`[main] Failed to load model:`,e),fp=$.getModel()}).finally(()=>{pp()});function pp(){let e=!0,t=Uf(()=>{let n=$.getModel();n&&(e=!e,n.visible=e,t.innerHTML=e?Bf:Vf,t.dataset.visible=String(e),$.requestRender())}),n=new Zf(e=>{t.classList.toggle(`is-hidden`,e),a(e,n),e?(rp(),S()):rp()},{controls:$.controls,camera:$.camera,fitCamera:$.fitCamera},dp??lp),r=kf(`btn`)??`tl`;t.dataset.corner=r,document.body.appendChild(t);let i=jf((e,n)=>{e===`btn`&&(t.dataset.corner=n)});function a(e,t){let n=window.innerWidth,r=window.innerHeight,i=n,a=0;if(e){let e=t.panelElement.offsetWidth;i=n-e,t.side===`left`&&(a=e)}$.camera.aspect=i/r,$.camera.updateProjectionMatrix(),$.renderer.setSize(i,r),up.style.left=a+`px`,$.requestRender()}window.removeEventListener(`resize`,$.resize);function o(){a(n.panelOpen,n)}window.addEventListener(`resize`,o),$.resize=o;let s=Lf(()=>dp,$.controls,$.camera);function c(){let e=kf(`keylight`);e&&(Sd($.keyLight,e),$.requestRender())}c();let l=jf(e=>{e===`keylight`&&c()});function u(){let e=kf(`fill`);e&&(Cd($.fillLight,e),$.requestRender())}u();let d=jf(e=>{e===`fill`&&u()});function f(){let e=kf(`rim`);e&&(wd($.rimLight,e),$.requestRender())}f();let p=jf(e=>{e===`rim`&&f()});function m(){let e=kf(`bg`);e&&(document.documentElement.style.backgroundColor=e,document.body.style.backgroundColor=e,$.scene.background=new X(e),$.requestRender())}m();let h=jf(e=>{e===`bg`&&m()});function g(){let e=kf(`ambient`);e!==void 0&&(Td($.ambientLight,e),$.requestRender())}g();let _=jf(e=>{e===`ambient`&&g()});function v(){fp&&(zd(fp,kf(`gloss`)),$.requestRender())}v();let y=jf(e=>{e===`gloss`&&v()});function b(){if(fp){let e=kf(`material`);e&&(kd(fp,e),$.requestRender())}}b();let x=jf(e=>{e===`material`&&b()});function S(){let e=uf($.controls,$.camera);np(dp,$.renderer,e).then(e=>{let t=document.querySelector(`[data-setting-id="material"]`);if(!t)return;let n=t._setThumbnail;if(n)for(let[t,r]of e)n(t,r)})}S();let C=$.dispose.bind($);$.dispose=()=>{s(),l(),d(),p(),h(),_(),y(),x(),i(),op(),window.removeEventListener(`resize`,o),n.dispose(),t.remove(),C()}}export{ns as $,l as A,$r as B,Pe as C,Pi as D,Hi as E,ds as F,oo as G,lo as H,Mr as I,c as J,a as K,kt as L,u as M,Ve as N,qi as O,Io as P,ss as Q,K as R,_o as S,R as T,co as U,Vr as V,so as W,To as X,s as Y,wn as Z,ps as _,pr as _t,fr as a,Do as at,Or as b,J as bt,X as c,Nn as ct,Ho as d,di as dt,os as et,ls as f,yr as ft,Tn as g,qn as gt,hr as h,Uo as ht,Jn as i,At as it,d as j,Ki as k,q as l,Ka as lt,zo as m,Kt as mt,Ao as n,Ji as nt,Dr as o,r as ot,sn as p,is as pt,o as q,fi as r,ks as rt,i as s,Be as st,us as t,$i as tt,da as u,gi as ut,_i as v,W as vt,Ne as w,Ar as x,ko as xt,Ti as y,G as yt,Y as z};