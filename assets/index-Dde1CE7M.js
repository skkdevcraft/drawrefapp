const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FBXLoader-CPMa1paZ.js","assets/fflate.module-BIQmJeC9.js","assets/3MFLoader-D8TeeKKM.js"])))=>i.map(i=>d[i]);
...
void main() {
    ...
    touch-action: none;
    user-select: none;
  `;let r=`http://www.w3.org/2000/svg`,i=document.createElementNS(r,`svg`);i.setAttribute(`viewBox`,`0 0 ${Zd} ${Qd}`),i.setAttribute(`width`,String(Zd)),i.setAttribute(`height`,String(Qd)),i.style.display=`block`;let a=document.createElementNS(r,`circle`);a.setAttribute(`cx`,String($d)),a.setAttribute(`cy`,String(Qd*.38)),a.setAttribute(`r`,String(ef)),a.setAttribute(`fill`,`none`),a.setAttribute(`stroke`,`var(--border)`),a.setAttribute(`stroke-width`,`2`),i.append(a);let o=document.createElementNS(r,`path`);o.setAttribute(`fill`,`none`),o.setAttribute(`stroke`,`var(--accent)`),o.setAttribute(`stroke-width`,`3`),o.setAttribute(`stroke-linecap`,`round`),i.append(o);let s=document.createElementNS(r,`path`);s.setAttribute(`fill`,`none`),s.setAttribute(`stroke`,`var(--border)`),s.setAttribute(`stroke-width`,`2`),i.append(s);let c=document.createElementNS(r,`path`);c.setAttribute(`fill`,`none`),c.setAttribute(`stroke`,`var(--accent)`),c.setAttribute(`stroke-width`,`3`),c.setAttribute(`stroke-linecap`,`round`),i.append(c);let l=document.createElementNS(r,`path`);l.setAttribute(`fill`,`none`),l.setAttribute(`stroke`,`var(--border)`),l.setAttribute(`stroke-width`,`2`),i.append(l);let u=document.createElementNS(r,`path`);u.setAttribute(`fill`,`none`),u.setAttribute(`stroke`,`var(--accent)`),u.setAttribute(`stroke-width`,`3`),u.setAttribute(`stroke-linecap`,`round`),i.append(u);let d=document.createElementNS(r,`text`);d.setAttribute(`x`,String($d-ef-2)),d.setAttribute(`y`,`234.2`),d.setAttribute(`text-anchor`,`end`),d.setAttribute(`fill`,`var(--text-muted)`),d.setAttribute(`font-size`,`10`),d.setAttribute(`font-family`,`var(--font-sans)`),d.textContent=`◀`,i.append(d);let f=document.createElementNS(r,`text`);f.setAttribute(`x`,`182`),f.setAttribute(`y`,`234.2`),f.setAttribute(`text-anchor`,`start`),f.setAttribute(`fill`,`var(--text-muted)`),f.setAttribute(`font-size`,`10`),f.setAttribute(`font-family`,`var(--font-sans)`),f.textContent=`▶`,i.append(f);let p=document.createElementNS(r,`path`);p.setAttribute(`fill`,`none`),p.setAttribute(`stroke`,`var(--border)`),p.setAttribute(`stroke-width`,`2`),i.append(p);let m=document.createElementNS(r,`path`);m.setAttribute(`fill`,`none`),m.setAttribute(`stroke`,`var(--accent)`),m.setAttribute(`stroke-width`,`3`),m.setAttribute(`stroke-linecap`,`round`),i.append(m);let h=document.createElementNS(r,`text`);h.setAttribute(`x`,String($d-ef-2)),h.setAttribute(`y`,`266.2`),h.setAttribute(`text-anchor`,`end`),h.setAttribute(`fill`,`var(--text-muted)`),h.setAttribute(`font-size`,`10`),h.setAttribute(`font-family`,`var(--font-sans)`),h.textContent=`◀`,i.append(h);let g=document.createElementNS(r,`text`);g.setAttribute(`x`,`182`),g.setAttribute(`y`,`266.2`),g.setAttribute(`text-anchor`,`start`),g.setAttribute(`fill`,`var(--text-muted)`),g.setAttribute(`font-size`,`10`),g.setAttribute(`font-family`,`var(--font-sans)`),g.textContent=`▶`,i.append(g);function _(e,t){let n=document.createElementNS(r,`text`);return n.setAttribute(`x`,String($d)),n.setAttribute(`y`,String(t)),n.setAttribute(`text-anchor`,`middle`),n.setAttribute(`fill`,`var(--text-secondary)`),n.setAttribute(`font-size`,`9`),n.setAttribute(`font-family`,`var(--font-sans)`),n.setAttribute(`opacity`,`0.7`),n.textContent=e,i.append(n),n}_(`SOFTNESS`,218.2),_(`INTENSITY`,250.2);let v=document.createElementNS(r,`circle`);v.setAttribute(`r`,`8`),v.setAttribute(`fill`,`var(--accent)`),v.setAttribute(`stroke`,`#fff`),v.setAttribute(`stroke-width`,`2`),v.setAttribute(`cursor`,`grab`),i.append(v);let y=document.createElementNS(r,`circle`);y.setAttribute(`r`,`14`),y.setAttribute(`fill`,`none`),y.setAttribute(`stroke`,`var(--accent)`),y.setAttribute(`stroke-width`,`1`),y.setAttribute(`opacity`,`0.3`),i.append(y);let b=document.createElementNS(r,`circle`);b.setAttribute(`r`,String(nf)),b.setAttribute(`fill`,`var(--accent)`),b.setAttribute(`stroke`,`#fff`),b.setAttribute(`stroke-width`,`2`),b.setAttribute(`cursor`,`grab`),i.append(b);let x=document.createElementNS(r,`circle`);x.setAttribute(`r`,String(nf)),x.setAttribute(`fill`,`var(--accent-hover)`),x.setAttribute(`stroke`,`#fff`),x.setAttribute(`stroke-width`,`2`),x.setAttribute(`cursor`,`grab`),i.append(x);let S=document.createElementNS(r,`circle`);S.setAttribute(`r`,String(nf)),S.setAttribute(`fill`,`var(--accent-hover)`),S.setAttribute(`stroke`,`#fff`),S.setAttribute(`stroke-width`,`2`),S.setAttribute(`cursor`,`grab`),i.append(S);let C=document.createElementNS(r,`circle`);C.setAttribute(`r`,String(nf)),C.setAttribute(`fill`,`var(--accent-hover)`),C.setAttribute(`stroke`,`#fff`),C.setAttribute(`stroke-width`,`2`),C.setAttribute(`cursor`,`grab`),i.append(C);let w=document.createElement(`div`);w.style.cssText=`
    display: grid;
  ...
  `;function T(e){w.innerHTML=`
    ...
    `}n.append(i,w);let E=Qd*.38;function D(e,t){let n=(e-90)*(Math.PI/180);return{x:$d+t*Math.cos(n),y:E+t*Math.sin(n)}}function O(e,t){let n=e-$d,r=t-E,i=180/Math.PI*Math.atan2(r,n)+90;return i<0&&(i+=360),i%360}function k(e){let t=(e+180)*(Math.PI/180);return{x:$d+tf*Math.cos(t),y:E+tf*Math.sin(t)}}function A(e,t){let n=e-$d,r=t-E,i=180/Math.PI*Math.atan2(r,n);return i<0&&(i+=360),i>=180&&i<=270?i-180:i<180?0:90}function ee(e,t){let n=e-$d,r=t-E,i=Math.sqrt(n*n+r*r),a=ef*.65;return(1-Math.min(a,Math.max(0,i))/a)*90}function te(e){return{x:$d-ef+e*2*ef,y:230.2}}function j(e){return(Math.min(180,Math.max($d-ef,e))-($d-ef))/(2*ef)}function ne(e){let t=Math.min(1,Math.max(0,e/5));return{x:$d-ef+t*2*ef,y:262.2}}function M(e){return(Math.min(180,Math.max($d-ef,e))-($d-ef))/(2*ef)*5}function N(e,t,n,r,i){if(Math.abs(i-r)<.01)return``;let a=(r-90)*(Math.PI/180),o=(i-90)*(Math.PI/180),s=e+n*Math.cos(a),c=t+n*Math.sin(a),l=e+n*Math.cos(o),u=t+n*Math.sin(o);return`M ${s} ${c} A ${n} ${n} 0 ${+(Math.abs(i-r)>180)} 1 ${l} ${u}`}function re(e,t,n){return`M ${e} ${t} L ${n} ${t}`}function ie(e){o.setAttribute(`d`,e.azimuth>0?N($d,E,ef,0,e.azimuth):``);let t=D(e.azimuth,ef);b.setAttribute(`cx`,String(t.x)),b.setAttribute(`cy`,String(t.y));let n=N($d,E,tf,270,360);s.setAttribute(`d`,n),e.elevation>0?c.setAttribute(`d`,N($d,E,tf,270,270+e.elevation)):c.setAttribute(`d`,``);let r=k(e.elevation);x.setAttribute(`cx`,String(r.x)),x.setAttribute(`cy`,String(r.y));let i=$d-ef,a=230.2;l.setAttribute(`d`,re(i,a,180));let d=te(e.softness);u.setAttribute(`d`,re(i,a,d.x)),S.setAttribute(`cx`,String(d.x)),S.setAttribute(`cy`,String(d.y));let f=262.2;p.setAttribute(`d`,re(i,f,180));let h=ne(e.intensity);m.setAttribute(`d`,re(i,f,h.x)),C.setAttribute(`cx`,String(h.x)),C.setAttribute(`cy`,String(h.y));let g=(e.azimuth-90)*(Math.PI/180),_=(1-e.elevation/90)*ef*.65,w=$d+_*Math.cos(g),O=E+_*Math.sin(g);v.setAttribute(`cx`,String(w)),v.setAttribute(`cy`,String(O)),y.setAttribute(`cx`,String(w)),y.setAttribute(`cy`,String(O)),T(e)}ie(e);let ae=null;function oe(e,t){let n=i.getBoundingClientRect(),r=e-n.left,a=t-n.top,o=Zd/n.width,s=Qd/n.height,c=r*o,l=a*s,u=c-$d,d=l-E,f=Math.sqrt(u*u+d*d);return Math.abs(l-230.2)<rf*s*.4&&Math.abs(c-$d)<ef+rf*o*.4?`softness`:Math.abs(l-262.2)<rf*s*.4&&Math.abs(c-$d)<ef+rf*o*.4?`intensity`:c<$d&&Math.abs(f-tf)<rf*o*.5?`elevation`:Math.abs(f-ef)<rf*o*.5?`azimuth`:f<ef+rf*o*.3?`direction`:null}function P(e){e.preventDefault(),i.setPointerCapture(e.pointerId);let t=oe(e.clientX,e.clientY);if(t){ae=t;let n=e.currentTarget;n.style.cursor=`grabbing`,F(e,t)}}function se(e){ae&&(e.preventDefault(),F(e,ae))}function ce(e){if(!ae)return;ae=null;let t=e.currentTarget;t.style.cursor=`default`,i.releasePointerCapture(e.pointerId)}function F(n,r){let a=i.getBoundingClientRect(),o=Zd/a.width,s=Qd/a.height,c=(n.clientX-a.left)*o,l=(n.clientY-a.top)*s,u={...e};switch(r){case`azimuth`:u.azimuth=O(c,l);break;case`elevation`:u.elevation=A(c,l);break;case`softness`:u.softness=Math.min(1,Math.max(0,j(c)));break;case`intensity`:u.intensity=Math.min(5,Math.max(0,M(c)));break;case`direction`:u.azimuth=O(c,l),u.elevation=ee(c,l);break}e=u,ie(u),t(u)}return i.addEventListener(`pointerdown`,P),i.addEventListener(`pointermove`,se),i.addEventListener(`pointerup`,ce),i.addEventListener(`pointercancel`,ce),n._updateLight=t=>{e=t,ie(t)},n._dispose=()=>{i.removeEventListener(`pointerdown`,P),i.removeEventListener(`pointermove`,se),i.removeEventListener(`pointerup`,ce),i.removeEventListener(`pointercancel`,ce)},n}var of={id:`btn`,label:`Button Position`,type:`select`,defaultValue:`tl`,serialize:e=>e,deserialize:e=>e===`tl`||e===`tr`||e===`bl`||e===`br`?e:`tl`,createControl(e,t){let n=document.createElement(`select`);for(let[e,t]of[[`tl`,`Top Left`],[`tr`,`Top Right`],[`bl`,`Bottom Left`],[`br`,`Bottom Right`]]){let r=document.createElement(`option`);r.value=e,r.textContent=t,n.append(r)}return n.value=e,n.onchange=()=>t(n.value),n}};function sf(e,t,n){return Math.min(n,Math.max(t,e))}var cf={id:`keylight`,label:`Key Light`,type:`light`,defaultValue:{azimuth:45,elevation:30,intensity:1,softness:.5},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...cf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...cf.defaultValue}:{azimuth:sf(t[0],0,360),elevation:sf(t[1],0,90),intensity:sf(t[2],0,5),softness:sf(t[3],0,1)}},createControl(e,t){return af(e,t)}},lf={id:`fill`,label:`Fill Light`,type:`light`,defaultValue:{azimuth:225,elevation:20,intensity:.4,softness:0},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...lf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...lf.defaultValue}:{azimuth:sf(t[0],0,360),elevation:sf(t[1],0,90),intensity:sf(t[2],0,5),softness:sf(t[3],0,1)}},createControl(e,t){return af(e,t)}},uf={id:`rim`,label:`Back Light`,type:`light`,defaultValue:{azimuth:180,elevation:30,intensity:.3,softness:0},serialize(e){let{azimuth:t,elevation:n,intensity:r,softness:i}=e;return`${t},${n},${r},${i}`},deserialize(e){if(e===null)return{...uf.defaultValue};let t=e.split(`,`).map(e=>e.trim()).map(Number);return t.length!==4||t.some(isNaN)?{...uf.defaultValue}:{azimuth:sf(t[0],0,360),elevation:sf(t[1],0,90),intensity:sf(t[2],0,5),softness:sf(t[3],0,1)}},createControl(e,t){return af(e,t)}},df=[of,{id:`gloss`,label:`Glossiness`,type:`number`,defaultValue:.6,serialize:e=>String(e),deserialize:e=>{if(e===null)return .6;let t=parseFloat(e);return isNaN(t)?.6:Math.min(1,Math.max(0,t))},createControl(e,t){let n=document.createElement(`div`);n.style.cssText=`
      display: flex;
      align-items: center;
      gap: 10px;
      min-height: 44px;
    ...
    `;let i=document.createElement(`span`);return i.style.cssText=`
      ...
      min-width: 28px;
      text-align: right;
    `,i.textContent=e.toFixed(2),r.oninput=()=>{let e=parseFloat(r.value);i.textContent=e.toFixed(2),t(e)},n.append(r,i),n}},cf,lf,uf],ff={};for(let e of df)ff[e.id]=e.defaultValue;var pf=new Set;function mf(e){return ff[e]}function hf(e,t){ff[e]=t;for(let n of pf)n(e,t)}function gf(e){return pf.add(e),()=>{pf.delete(e)}}var _f=1;function vf(e,t,n){let r=new URLSearchParams;r.set(`v`,String(_f)),e&&e.length>0&&r.set(`model`,e);let i=Yd(t,n);r.set(`cam`,`${i.theta},${i.phi},${i.radius}`);for(let e of df){let t=mf(e.id);t!==e.defaultValue&&r.set(e.id,e.serialize(t))}return r.toString()}function yf(e){let t=new URLSearchParams(e??window.location.search),n=t.get(`v`);if(n===null)return{version:_f,model:null,camera:null,settings:{}};let r=parseInt(n,10);if(isNaN(r)||r!==1)return null;let i=t.get(`model`)||null,a=null,o=t.get(`cam`);if(o){let e=o.split(`,`).map(e=>e.trim()).map(Number);e.length===3&&e.every(e=>!isNaN(e))&&(a={theta:e[0],phi:e[1],radius:e[2]})}let s={};for(let e of df)s[e.id]=e.deserialize(t.get(e.id));return{version:r,model:i,camera:a,settings:s}}function bf(e,t){let n=null;function r(...r){n!==null&&clearTimeout(n),n=setTimeout(()=>{n=null,e(...r)},t)}function i(){n!==null&&(clearTimeout(n),n=null)}return{call:r,cancel:i}}function xf(e,t,n){let r=vf(e,t,n),i=r.length>0?`?${r}`:window.location.pathname;history.pushState(null,``,i)}function Sf(e,t,n){let r=bf(()=>{xf(e(),t,n)},300),i=gf(()=>{r.call()}),a=()=>{r.call()};return t.addEventListener(`change`,a),function(){i(),t.removeEventListener(`change`,a),r.cancel()}}function Cf(){let e=document.createDocumentFragment();for(let t of df){let n=mf(t.id),r=document.createElement(`div`);r.className=`settings-row`;let i=document.createElement(`label`);i.className=`settings-label`,i.textContent=t.label;let a=t.createControl(n,e=>{hf(t.id,e)});a.dataset.settingId=t.id,a.className=`${a.className||``} settings-control`.trim(),r.append(i,a),e.append(r)}return e}var wf=`<svg width="22" height="22" viewBox="0 0 24 24" fill="none"
  ...
  </svg>`;function Tf(e){let t=document.createElement(`button`);return t.id=`settings-toggle`,t.className=`settings-toggle`,t.setAttribute(`aria-label`,`Toggle settings panel`),t.innerHTML=wf,t.addEventListener(`click`,e),t}var Ef={keylight:{azimuth:45,elevation:30,intensity:1,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}},Df=[{label:`Front`,theta:0,phi:0,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}}},{label:`Side`,theta:90,phi:0,lights:{keylight:{azimuth:315,elevation:30,intensity:1.2,softness:.5},fill:{azimuth:135,elevation:15,intensity:.4,softness:0},rim:{azimuth:90,elevation:35,intensity:.4,softness:0}}},{label:`Three Quarter`,theta:45,phi:30,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:35,intensity:.4,softness:0}}},{label:`Top`,theta:0,phi:90,lights:{keylight:{azimuth:45,elevation:60,intensity:1,softness:.5},fill:{azimuth:225,elevation:45,intensity:.3,softness:0},rim:{azimuth:180,elevation:10,intensity:.3,softness:0}}}];function Of(e){hf(`keylight`,{...e.keylight}),hf(`fill`,{...e.fill}),hf(`rim`,{...e.rim})}function kf(){hf(`keylight`,{...Ef.keylight}),hf(`fill`,{...Ef.fill}),hf(`rim`,{...Ef.rim})}function Af(e,t,n){let r=document.createElement(`div`);r.className=`view-presets`;let i=document.createElement(`span`);i.className=`settings-label`,i.textContent=`View Presets`,r.append(i);let a=document.createElement(`div`);a.className=`view-presets-grid`;for(let n of Df){let r=document.createElement(`button`);r.className=`view-preset-btn`,r.textContent=n.label,r.addEventListener(`click`,()=>{let r=Yd(e,t);Xd(e,t,{theta:n.theta,phi:n.phi,radius:r.radius}),n.lights&&Of(n.lights)}),a.append(r)}let o=document.createElement(`button`);return o.className=`view-preset-btn view-preset-btn--reset`,o.textContent=`Reset`,o.addEventListener(`click`,()=>{n(1),kf()}),a.append(o),r.append(a),r}var jf=class{button;panel;isOpen=!1;unsub=null;currentSide=`left`;onToggle;viewerControls;constructor(e,t){this.onToggle=e??null,this.button=Tf(()=>this.toggle()),this.panel=document.createElement(`aside`),this.panel.id=`settings-panel`,this.panel.className=`settings-panel`,this.viewerControls=t??null,this.populatePanel(),document.body.append(this.panel,this.button),this.onKeyDown=this.onKeyDown.bind(this),document.addEventListener(`keydown`,this.onKeyDown);let n=mf(`btn`)??`tl`;this.applyPosition(n),this.unsub=gf((e,t)=>{e===`btn`&&(this.applyPosition(t),this.isOpen&&this.onToggle?.(!0));let n=this.panel.querySelector(`[data-setting-id="${e}"]`);if(n){let e=n._updateLight;e?e(t):`value`in n&&(n.value=String(t))}})}get panelElement(){return this.panel}get side(){return this.currentSide}get panelOpen(){return this.isOpen}applyPosition(e){this.button.dataset.corner=e,this.panel.dataset.corner=e,this.currentSide=e===`tl`||e===`bl`?`left`:`right`,this.panel.dataset.side=this.currentSide}toggle(){this.isOpen?this.close():this.open()}open(){this.isOpen||(this.isOpen=!0,this.button.classList.add(`is-active`),this.panel.classList.add(`is-open`),this.onToggle?.(!0))}close(){this.isOpen&&(this.isOpen=!1,this.button.classList.remove(`is-active`),this.panel.classList.remove(`is-open`),this.onToggle?.(!1))}onKeyDown(e){e.key===`Escape`&&this.isOpen&&this.close()}populatePanel(){if(this.panel.append(Cf()),this.viewerControls){let e=Af(this.viewerControls.controls,this.viewerControls.camera,this.viewerControls.fitCamera);this.panel.append(e)}}dispose(){document.removeEventListener(`keydown`,this.onKeyDown),this.unsub&&this.unsub(),this.button.remove(),this.panel.remove()}};function Mf(e){let t=vd(e),n=yd(),r=Td(),i=Dd(r,e),{keyLight:a,fillLight:o,rimLight:s}=bd(n),c=null;c=Ad(),n.add(c);function l(e){c&&n.remove(c),c=e,n.add(e),Ed(r,i,1),d()}function u(e=1){Ed(r,i,e)}let{requestRender:d,dispose:f}=Od(t,n,r,i);i.addEventListener(`change`,()=>{d()}),d();function p(){let e=window.innerWidth,n=window.innerHeight;r.aspect=e/n,r.updateProjectionMatrix(),t.setSize(e,n),d()}window.addEventListener(`resize`,p);let m=window.matchMedia(`(prefers-color-scheme: dark)`);function h(){wd(n),d()}m.addEventListener(`change`,h);function g(){f(),i.dispose(),t.dispose(),window.removeEventListener(`resize`,p),m.removeEventListener(`change`,h)}return{renderer:t,scene:n,camera:r,controls:i,keyLight:a,fillLight:o,rimLight:s,resize:p,fitCamera:u,requestRender:d,dispose:g,setModel:l,getModel:()=>c}}var Nf=yf(),Pf=Nf&&Nf.model&&Nf.model.trim().length>0?Nf.model:`skull3.obj`;if(Nf)for(let e of df){let t=Nf.settings[e.id];t!==void 0&&hf(e.id,t)}var Ff=document.getElementById(`scene-canvas`);if(!Ff)throw Error(`Expected a <canvas id="scene-canvas"> element in the DOM`);var If=Mf(Ff),Lf=null,Rf=null;function zf(e){let t=1-mf(`gloss`);e.traverse(e=>{if(e instanceof $r){let n=e.material;if(Array.isArray(n))for(let e of n)e instanceof oo&&(e.roughness=t,e.needsUpdate=!0);else n instanceof oo&&(n.roughness=t,n.needsUpdate=!0)}})}Wd(Pf).then(e=>{Gd(e,1),Lf=Pf,Rf=e,zf(e),If.setModel(e),Nf?.camera&&(Xd(If.controls,If.camera,Nf.camera),If.requestRender())}).catch(e=>{console.error(`[main] Failed to load model:`,e),Rf=If.getModel()}).finally(()=>{Bf()});function Bf(){let e=new jf(n=>{t(n,e)},{controls:If.controls,camera:If.camera,fitCamera:If.fitCamera});function t(e,t){let n=window.innerWidth,r=window.innerHeight,i=n,a=0;if(e){let e=t.panelElement.offsetWidth;i=n-e,t.side===`left`&&(a=e)}If.camera.aspect=i/r,If.camera.updateProjectionMatrix(),If.renderer.setSize(i,r),Ff.style.left=a+`px`,If.requestRender()}window.removeEventListener(`resize`,If.resize);function n(){t(e.panelOpen,e)}window.addEventListener(`resize`,n),If.resize=n;let r=Sf(()=>Lf,If.controls,If.camera);function i(){let e=mf(`keylight`);e&&(xd(If.keyLight,e),If.requestRender())}i();let a=gf(e=>{e===`keylight`&&i()});function o(){let e=mf(`fill`);e&&(Sd(If.fillLight,e),If.requestRender())}o();let s=gf(e=>{e===`fill`&&o()});function c(){let e=mf(`rim`);e&&(Cd(If.rimLight,e),If.requestRender())}c();let l=gf(e=>{e===`rim`&&c()});function u(){Rf&&(zf(Rf),If.requestRender())}u();let d=gf(e=>{e===`gloss`&&u()}),f=If.dispose.bind(If);If.dispose=()=>{r(),a(),s(),l(),d(),window.removeEventListener(`resize`,n),e.dispose(),f()}}export{ns as $,l as A,$r as B,Ne as C,Pi as D,Hi as E,ds as F,oo as G,lo as H,Mr as I,c as J,a as K,Ot as L,u as M,Be as N,qi as O,Io as P,ss as Q,q as R,_o as S,z as T,co as U,Vr as V,so as W,To as X,s as Y,wn as Z,ps as _,pr as _t,fr as a,Do as at,Or as b,Kt as bt,X as c,Nn as ct,Ho as d,di as dt,os as et,ls as f,yr as ft,Tn as g,qn as gt,hr as h,Uo as ht,Jn as i,kt as it,d as j,Ki as k,J as l,Ka as lt,zo as m,Gt as mt,Ao as n,Ji as nt,Dr as o,r as ot,sn as p,is as pt,o as q,fi as r,ks as rt,i as s,ze as st,us as t,$i as tt,da as u,gi as ut,_i as v,G as vt,Me as w,Ar as x,ko as xt,Ti as y,K as yt,Y as z};