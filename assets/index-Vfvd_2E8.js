const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/FBXLoader-BZa8S9Sb.js","assets/fflate.module-BIQmJeC9.js","assets/3MFLoader-B3DuJIzu.js"])))=>i.map(i=>d[i]);
...
void main() {
  ...
  `;function T(e){w.innerHTML=`
    ...
    `;let i=document.createElement(`span`);return i.style.cssText=`
      ...
      min-width: 28px;
      text-align: right;
    `,i.textContent=e.toFixed(2),r.oninput=()=>{let e=parseFloat(r.value);i.textContent=e.toFixed(2),t(e)},n.append(r,i),n}},Nd,Sf,Cf,wf],Ef={};for(let e of Tf)Ef[e.id]=e.defaultValue;var Df=new Set;function Of(e){return Ef[e]}function kf(e,t){Ef[e]=t;for(let n of Df)n(e,t)}function Af(e){return Df.add(e),()=>{Df.delete(e)}}var jf=1;function Mf(e,t,n){let r=new URLSearchParams;r.set(`v`,String(jf)),e&&e.length>0&&r.set(`model`,e);let i=uf(t,n);r.set(`cam`,`${i.theta},${i.phi},${i.radius}`);for(let e of Tf){let t=Of(e.id);t!==e.defaultValue&&r.set(e.id,e.serialize(t))}return r.toString()}function Nf(e){let t=new URLSearchParams(e??window.location.search),n=t.get(`v`);if(n===null)return{version:jf,model:null,camera:null,settings:{}};let r=parseInt(n,10);if(isNaN(r)||r!==1)return null;let i=t.get(`model`)||null,a=null,o=t.get(`cam`);if(o){let e=o.split(`,`).map(e=>e.trim()).map(Number);e.length===3&&e.every(e=>!isNaN(e))&&(a={theta:e[0],phi:e[1],radius:e[2]})}let s={};for(let e of Tf)s[e.id]=e.deserialize(t.get(e.id));return{version:r,model:i,camera:a,settings:s}}function Pf(e,t){let n=null;function r(...r){n!==null&&clearTimeout(n),n=setTimeout(()=>{n=null,e(...r)},t)}function i(){n!==null&&(clearTimeout(n),n=null)}return{call:r,cancel:i}}function Ff(e,t,n){let r=Mf(e,t,n),i=r.length>0?`?${r}`:window.location.pathname;history.pushState(null,``,i)}function If(e,t,n){let r=Pf(()=>{Ff(e(),t,n)},300),i=Af(()=>{r.call()}),a=()=>{r.call()};return t.addEventListener(`change`,a),function(){i(),t.removeEventListener(`change`,a),r.cancel()}}function Lf(){let e=document.createDocumentFragment();for(let t of Tf){let n=Of(t.id),r=document.createElement(`div`);r.className=`settings-row`;let i=document.createElement(`label`);i.className=`settings-label`,i.textContent=t.label;let a=t.createControl(n,e=>{kf(t.id,e)});a.dataset.settingId=t.id,a.className=`${a.className||``} settings-control`.trim(),r.append(i,a),e.append(r)}return e}var Rf=`<svg width="22" height="22" viewBox="0 0 24 24" fill="none"
  ...
  </svg>`,zf=`<svg width="22" height="22" viewBox="0 0 24 24" fill="none"
       stroke="currentColor" stroke-width="2" stroke-linecap="round"
       stroke-linejoin="round">
  ...
  </svg>`;function Vf(e){let t=document.createElement(`button`);return t.id=`settings-toggle`,t.className=`settings-toggle`,t.setAttribute(`aria-label`,`Toggle settings panel`),t.innerHTML=Rf,t.addEventListener(`click`,e),t}function Hf(e){let t=document.createElement(`button`);return t.id=`eye-toggle`,t.className=`eye-toggle`,t.setAttribute(`aria-label`,`Toggle model visibility`),t.innerHTML=zf,t.dataset.visible=`true`,t.addEventListener(`click`,e),t}var Uf={keylight:{azimuth:45,elevation:30,intensity:1,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}},Wf=[{label:`Front`,theta:0,phi:0,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:30,intensity:.3,softness:0}}},{label:`Side`,theta:90,phi:0,lights:{keylight:{azimuth:315,elevation:30,intensity:1.2,softness:.5},fill:{azimuth:135,elevation:15,intensity:.4,softness:0},rim:{azimuth:90,elevation:35,intensity:.4,softness:0}}},{label:`Three Quarter`,theta:45,phi:30,lights:{keylight:{azimuth:45,elevation:35,intensity:1.2,softness:.5},fill:{azimuth:225,elevation:20,intensity:.4,softness:0},rim:{azimuth:180,elevation:35,intensity:.4,softness:0}}},{label:`Top`,theta:0,phi:90,lights:{keylight:{azimuth:45,elevation:60,intensity:1,softness:.5},fill:{azimuth:225,elevation:45,intensity:.3,softness:0},rim:{azimuth:180,elevation:10,intensity:.3,softness:0}}}];function Gf(e){kf(`keylight`,{...e.keylight}),kf(`fill`,{...e.fill}),kf(`rim`,{...e.rim})}function Kf(){kf(`keylight`,{...Uf.keylight}),kf(`fill`,{...Uf.fill}),kf(`rim`,{...Uf.rim})}function qf(e,t,n){let r=document.createElement(`div`);r.className=`view-presets`;let i=document.createElement(`span`);i.className=`settings-label`,i.textContent=`View Presets`,r.append(i);let a=document.createElement(`div`);a.className=`view-presets-grid`;for(let n of Wf){let r=document.createElement(`button`);r.className=`view-preset-btn`,r.textContent=n.label,r.addEventListener(`click`,()=>{let r=uf(e,t);df(e,t,{theta:n.theta,phi:n.phi,radius:r.radius}),n.lights&&Gf(n.lights)}),a.append(r)}let o=document.createElement(`button`);return o.className=`view-preset-btn view-preset-btn--reset`,o.textContent=`Reset`,o.addEventListener(`click`,()=>{n(1),Kf()}),a.append(o),r.append(a),r}var Jf={"skull.obj":{author:`deater07`,source:`https://free3d.com/3d-model/skull-human-anatomy-82445.html`},"head.obj":{author:`Ron lemen`,source:`Planes of the Head.blend`}};function Yf(e){return Jf[e]??null}var Xf=class{button;panel;isOpen=!1;unsub=null;currentSide=`left`;onToggle;viewerControls;modelName;constructor(e,t,n){this.modelName=n??null,this.onToggle=e??null,this.button=Vf(()=>this.toggle()),this.panel=document.createElement(`aside`),this.panel.id=`settings-panel`,this.panel.className=`settings-panel`,this.viewerControls=t??null,this.populatePanel(),document.body.append(this.panel,this.button),this.onKeyDown=this.onKeyDown.bind(this),document.addEventListener(`keydown`,this.onKeyDown);let r=Of(`btn`)??`tl`;this.applyPosition(r),this.unsub=Af((e,t)=>{e===`btn`&&(this.applyPosition(t),this.isOpen&&this.onToggle?.(!0));let n=this.panel.querySelector(`[data-setting-id="${e}"]`);if(n){let e=n._updateLight;if(e){e(t);return}let r=n._selectPreset;if(r){r(t);return}`value`in n&&(n.value=String(t))}})}get panelElement(){return this.panel}get side(){return this.currentSide}get panelOpen(){return this.isOpen}applyPosition(e){this.button.dataset.corner=e,this.panel.dataset.corner=e,this.currentSide=e===`tl`||e===`bl`?`left`:`right`,this.panel.dataset.side=this.currentSide}toggle(){this.isOpen?this.close():this.open()}open(){this.isOpen||(this.isOpen=!0,this.button.classList.add(`is-active`),this.panel.classList.add(`is-open`),this.onToggle?.(!0))}close(){this.isOpen&&(this.isOpen=!1,this.button.classList.remove(`is-active`),this.panel.classList.remove(`is-open`),this.onToggle?.(!1))}onKeyDown(e){e.key===`Escape`&&this.isOpen&&this.close()}setModelName(e){this.modelName=e,this.updateCredits()}creditsSection=null;renderCredits(){let e=document.createElement(`div`);if(e.className=`model-credits`,!this.modelName)return e.style.display=`none`,e;let t=Yf(this.modelName);if(!t)return e.style.display=`none`,e;let n=document.createElement(`div`);if(n.className=`credit-row`,n.innerHTML=`<span class="credit-label">Model</span><span class="credit-value credit-value--filename">${Zf(this.modelName)}</span>`,e.append(n),t.author){let n=document.createElement(`div`);n.className=`credit-row`,n.innerHTML=`<span class="credit-label">Author</span><span class="credit-value">${Zf(t.author)}</span>`,e.append(n)}if(t.source){let n=document.createElement(`div`);n.className=`credit-row`,/^https?:\/\//.test(t.source)?n.innerHTML=`<span class="credit-label">Source</span><a class="credit-value credit-value--link" href="${Zf(t.source)}" target="_blank" rel="noopener noreferrer">${Zf(t.source)}</a>`:n.innerHTML=`<span class="credit-label">Source</span><span class="credit-value">${Zf(t.source)}</span>`,e.append(n)}if(t.license){let n=document.createElement(`div`);n.className=`credit-row`,n.innerHTML=`<span class="credit-label">License</span><span class="credit-value">${Zf(t.license)}</span>`,e.append(n)}return e}updateCredits(){if(!this.creditsSection)return;let e=this.renderCredits();this.creditsSection.replaceWith(e),this.creditsSection=e}populatePanel(){if(this.panel.append(Lf()),this.viewerControls){let e=qf(this.viewerControls.controls,this.viewerControls.camera,this.viewerControls.fitCamera);this.panel.append(e)}this.creditsSection=this.renderCredits(),this.panel.append(this.creditsSection)}dispose(){document.removeEventListener(`keydown`,this.onKeyDown),this.unsub&&this.unsub(),this.button.remove(),this.panel.remove()}};function Zf(e){let t=document.createElement(`span`);return t.textContent=e,t.innerHTML}var Qf=120,$f=new Map,ep=null;async function tp(e,t,n){let r=e??`__fallback__`;if(ep===r){let e=new Map;for(let t of Ed){let n=$f.get(`${r}:${t}`);n&&e.set(t,n)}if(e.size===Ed.length)return e}await new Promise(e=>setTimeout(e,0));let i;i=e?await af(e):Wd(),of(i,1);let a=Of(`keylight`),o=Of(`fill`),s=Of(`rim`),c=Of(`gloss`),l=Of(`ambient`),u=getComputedStyle(document.documentElement).getPropertyValue(`--bg-primary`).trim()||`#111111`,d=new Map,f=t.getRenderTarget(),p=t.autoClear,m=new J;t.getViewport(m);let h=new J;t.getScissor(h);let g=t.getScissorTest(),_=new Jt(Qf,Qf);for(let e of Ed){i.traverse(e=>{e instanceof $r&&(Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())});let{scene:f,camera:p}=Rd({model:i,background:u,ambient:l,keylight:a,fill:o,rim:s,glossiness:c,material:e,cameraState:n&&{...n,radius:n.radius*.8},aspect:1,enableShadows:!1});t.autoClear=!0,t.setRenderTarget(_),t.setScissor(0,0,Qf,Qf),t.setScissorTest(!1),t.render(f,p);let m=new Uint8Array(Qf*Qf*4);t.readRenderTargetPixels(_,0,0,Qf,Qf,m),rp(m,Qf);let h=ip(m,Qf);d.set(e,h),$f.set(`${r}:${e}`,h),f.remove(i)}return i.traverse(e=>{e instanceof $r&&(e.geometry.dispose(),Array.isArray(e.material)?e.material.forEach(e=>e.dispose()):e.material.dispose())}),_.dispose(),t.setRenderTarget(f),t.setViewport(m),t.setScissor(h),t.setScissorTest(g),t.autoClear=p,ep=r,d}function np(){$f.clear(),ep=null}function rp(e,t){let n=t*4,r=new Uint8Array(n);for(let i=0;i<t/2;i++){let a=i*n,o=(t-1-i)*n;r.set(e.slice(a,a+n)),e.copyWithin(a,o,o+n),e.set(r,o)}}function ip(e,t){let n=document.createElement(`canvas`);n.width=t,n.height=t;let r=n.getContext(`2d`),i=r.createImageData(t,t);return i.data.set(e),r.putImageData(i,0,0),n.toDataURL(`image/png`)}function ap(){$f.clear(),ep=null}function op(e){let t=yd(e),n=bd(),r=Fd(),i=Vd(r,e),{ambientLight:a,keyLight:o,fillLight:s,rimLight:c}=xd(n,{enableShadows:!0,keylight:Of(`keylight`),fill:Of(`fill`),rim:Of(`rim`)}),l=null;l=Wd(),n.add(l);function u(e){l&&n.remove(l),l=e,n.add(e),Ld(r,i,1),f()}function d(e=1){Ld(r,i,e)}let{requestRender:f,dispose:p}=Hd(t,n,r,i);i.addEventListener(`change`,()=>{f()}),f();function m(){let e=window.innerWidth,n=window.innerHeight;r.aspect=e/n,r.updateProjectionMatrix(),t.setSize(e,n),f()}window.addEventListener(`resize`,m);function h(){p(),i.dispose(),t.dispose(),window.removeEventListener(`resize`,m)}return{renderer:t,scene:n,camera:r,controls:i,ambientLight:a,keyLight:o,fillLight:s,rimLight:c,resize:m,fitCamera:d,requestRender:f,dispose:h,setModel:u,getModel:()=>l}}var sp=Nf(),cp=sp&&sp.model&&sp.model.trim().length>0?sp.model:`skull.obj`;if(sp)for(let e of Tf){let t=sp.settings[e.id];t!==void 0&&kf(e.id,t)}var lp=document.getElementById(`scene-canvas`);if(!lp)throw Error(`Expected a <canvas id="scene-canvas"> element in the DOM`);var $=op(lp);{let e=Of(`bg`);e&&($.scene.background=new X(e)),$.requestRender()}var up=null,dp=null;af(cp).then(e=>{of(e,1),up=cp,dp=e;let t=Of(`material`);t&&kd(e,t),zd(e,Of(`gloss`)),$.setModel(e),sp?.camera&&(df($.controls,$.camera,sp.camera),$.requestRender())}).catch(e=>{console.error(`[main] Failed to load model:`,e),dp=$.getModel()}).finally(()=>{fp()});function fp(){let e=!0,t=Hf(()=>{let n=$.getModel();n&&(e=!e,n.visible=e,t.innerHTML=e?zf:Bf,t.dataset.visible=String(e),$.requestRender())}),n=new Xf(e=>{t.classList.toggle(`is-hidden`,e),a(e,n),e?(np(),S()):np()},{controls:$.controls,camera:$.camera,fitCamera:$.fitCamera},up??cp),r=Of(`btn`)??`tl`;t.dataset.corner=r,document.body.appendChild(t);let i=Af((e,n)=>{e===`btn`&&(t.dataset.corner=n)});function a(e,t){let n=window.innerWidth,r=window.innerHeight,i=n,a=0;if(e){let e=t.panelElement.offsetWidth;i=n-e,t.side===`left`&&(a=e)}$.camera.aspect=i/r,$.camera.updateProjectionMatrix(),$.renderer.setSize(i,r),lp.style.left=a+`px`,$.requestRender()}window.removeEventListener(`resize`,$.resize);function o(){a(n.panelOpen,n)}window.addEventListener(`resize`,o),$.resize=o;let s=If(()=>up,$.controls,$.camera);function c(){let e=Of(`keylight`);e&&(Sd($.keyLight,e),$.requestRender())}c();let l=Af(e=>{e===`keylight`&&c()});function u(){let e=Of(`fill`);e&&(Cd($.fillLight,e),$.requestRender())}u();let d=Af(e=>{e===`fill`&&u()});function f(){let e=Of(`rim`);e&&(wd($.rimLight,e),$.requestRender())}f();let p=Af(e=>{e===`rim`&&f()});function m(){let e=Of(`bg`);e&&($.scene.background=new X(e),$.requestRender())}m();let h=Af(e=>{e===`bg`&&m()});function g(){let e=Of(`ambient`);e!==void 0&&(Td($.ambientLight,e),$.requestRender())}g();let _=Af(e=>{e===`ambient`&&g()});function v(){dp&&(zd(dp,Of(`gloss`)),$.requestRender())}v();let y=Af(e=>{e===`gloss`&&v()});function b(){if(dp){let e=Of(`material`);e&&(kd(dp,e),$.requestRender())}}b();let x=Af(e=>{e===`material`&&b()});function S(){let e=uf($.controls,$.camera);tp(up,$.renderer,e).then(e=>{let t=document.querySelector(`[data-setting-id="material"]`);if(!t)return;let n=t._setThumbnail;if(n)for(let[t,r]of e)n(t,r)})}S();let C=$.dispose.bind($);$.dispose=()=>{s(),l(),d(),p(),h(),_(),y(),x(),i(),ap(),window.removeEventListener(`resize`,o),n.dispose(),t.remove(),C()}}export{ns as $,l as A,$r as B,Pe as C,Pi as D,Hi as E,ds as F,oo as G,lo as H,Mr as I,c as J,a as K,kt as L,u as M,Ve as N,qi as O,Io as P,ss as Q,K as R,_o as S,R as T,co as U,Vr as V,so as W,To as X,s as Y,wn as Z,ps as _,pr as _t,fr as a,Do as at,Or as b,J as bt,X as c,Nn as ct,Ho as d,di as dt,os as et,ls as f,yr as ft,Tn as g,qn as gt,hr as h,Uo as ht,Jn as i,At as it,d as j,Ki as k,q as l,Ka as lt,zo as m,Kt as mt,Ao as n,Ji as nt,Dr as o,r as ot,sn as p,is as pt,o as q,fi as r,ks as rt,i as s,Be as st,us as t,$i as tt,da as u,gi as ut,_i as v,W as vt,Ne as w,Ar as x,ko as xt,Ti as y,G as yt,Y as z};